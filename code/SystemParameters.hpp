...
public:
    ...
    CallbackParameter<TemperatureStatus> temperature1Status{ 
        TemperatureStatus::Nominal, temperature1StatusCallback };
    CallbackParameter<TemperatureStatus> temperature2Status{ 
        TemperatureStatus::Nominal, temperature2StatusCallback };
    FunctionParameter<TemperatureStatus> temperature12Status{[this]() {
        if (
            temperature1Status.getValue() == TemperatureStatus::Nominal && 
            temperature2Status.getValue() == TemperatureStatus::Nominal) {
