...
\begin{figure}
	...
	\includegraphics{media/screenshots/pus_f010_moni}
\end{figure}
...
\begin{figure}
	...
	\caption{Το γεγονός προσωρινής αποτυχίας του αισθητήρα όπως φαίνεται στο \acs{YAMCS}}
	\label{fig:yamcsf010event}
\end{figure}

Με την αποστολή του γεγονότος, πυροδοτείται ο μηχανισμός γεγονότος-αντίδρασης 
