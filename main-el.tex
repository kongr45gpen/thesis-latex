...
\begin{figure}
	...
	\caption[Ενεργοί δορυφόροι σε τροχιά γύρω από τη γη το 2021]{\g{Ενεργοί τεχνητοί δορυφόροι σε τροχιά γύρω από τη γη το 2021. Κοντά στον πλανήτη βρίσκονται οι δορυφόροι Χαμηλής Γήινης Τροχιάς. Σε σταθερό υψόμετρο }\SI{35786}{\kilo\meter}\g{ βρίσκονται οι δορυφόροι Γεωστατικής τροχιάς, και ανάμεσά τους κινούνται οι δορυφόροι Μέσης Γήινης Τροχιάς }\autocite{agi:analyticalgraphics_satellite_viewer}.}
...
\begin{marginfigure}
	...
	\end{tikzpicture}
	\caption{\g{Κατάσταση αποστολών CubeSat από το 2000 }\autocite{swartwout_cubesat_mission_2019}}
...
\begin{itemize}
	...
	\item Η μονάδα \textbf{ελέγχου και διανομής ισχύος} (\acs{PCDU}) προμηθεύεται από την NanoAvionics και προσφέρει 10 προστατευμένα κανάλια με 4 διαφορετικές τιμές τάσης, καθώς και 4 μετατροπείς \acs{MPPT}.
...
\marginnote{%
	...
	\textbf{\acl{event}} (event): Αξιοσημείωτο συμβάν που λαμβάνει χώρα στο δορυφόρο, όπως:
	\begin{compactitem}
	...
	\textbf{\acl{parameter}} (parameter): Μεταβλητός και αναγνώσιμος περιέκτης δεδομένων που μπορεί να αντιπροσωπεύει:
	\begin{itemize}
...
\begin{compactitem}
	...
	\item \textbf{\texttt{ST[03]}: Housekeeping}
		...
		Επιτρέπει τη φόρτωση, τον έλεγχο (εκκίνηση, αναστολή, συνέχιση, διακοπή) και τη ρύθμιση των "operations procedures", \g{δηλ. ακολουθιών εντολών σε κάποια ερμηνευμένη γλώσσα προγραμματισμού.}
...
\begin{enumerate}
	...
	\item \textbf{Διαμορφωσιμότητα} σε τροχιά: Είναι πολύ δύσκολο να προβλεφθεί η ακριβής συμπεριφορά του δορυφόρου σε τροχιά. Ως εκ τούτου, θα πρέπει να δίνεται η δυνατότητα στους \aclp{operator} για πλήρη διαμόρφωση και ρύθμιση του \acs{FDIR} αν χρειαστεί. Η διαμορφωσιμότητα αυτή μπορεί να περιλαμβάνει απενεργοποίηση ελέγχων, αλλαγές επικίνδυνων ορίων, ή ακόμα και εγκαστάσταση νέων ελέγχων.
...
\begin{table*}[h]
	...
	\begin{tabularx}{\textwidth}{@{}lcX@{}}
		...
		1 & Υλικό & \acl{microcontroller} ανθεκτικός στην ακτινοβολία \\
...
Προκειμένου να εξομοιώσουμε τις πιο βασικές λειτουργίες ενός υποσυστήματος διαστημικού σκάφους, υλοποιήσαμε ένα σύστημα με μία μόνο λειτουργική \acl{requirement}:
\begin{quote}
...
\begin{table*}[h]
	...
	\begin{tabularx}{\textwidth}{@{}lXp{6cm}@{}}
		...
		\textbf{\texttt{fdir-demo-yamcs}} & Λογισμικό Σταθμού Βάσης: \begin{enumerate}
			\item \acl{interface} με το \acs{YAMCS}
			\item Περιγραφή \acs{ECSS} πακέτων, αναγνώσιμη από μηχανή
			\item \acl{interface} \acs{UART}--\acs{USB} με τον μικροελεγκτή
...
Όλοι αυτοί οι ορισμοί μπορούν εύκολα να τροποποιηθούν από τους \aclp{operator} με τη χρήση μεμονωμένων τηλεεντολών, οι οποίες επιδρούν επάνω στην βάση δεδομένων του διαστημικού εξοπλισμού.
...
\begin{table*}[h]
	...
	\begin{tabularx}{\textwidth}{@{}lXlL{4cm}@{}}
		\toprule
		\# & \acl{requirement} & Υπηρεσία & Λεπτομέρειες \\ \midrule
...
\begin{itemize}
	\item Μία βιαστική υλοποίηση του \acs{FDIR} μπορεί να οδηγήσει σε μεγάλη αύξηση της πολυπλοκότητας, και δυσκολία διαχείρισης όλων των ορισμών αξιοπιστίας. Η πολυπλοκότητα αυξάνει την πιθανότητα ανθρώπινου λάθους, σφαλμάτων που δεν εντοπίζονται, αλλά και κακής λειτουργίας του συστήματος όταν αποστέλλονται πολλές εντολές που μπορεί να μην εκτελεστούν. Σε μη κρίσιμα συστήματα, προτείνεται το πλήθος των ορισμών να περιοριστεί σε έναν διαχειρίσιμο αριθμό. Ενδεικτικά στο παράδειγμά μας, θα μπορούσαν να αφαιρεθούν οι παρακολουθήσεις της διαφοράς \(Δ\) των θερμοκρασιών, αντικαθιστώμενες από έλεγχο ώστε και οι 2 αισθητήρες να είναι εκτός ορίων για την επανεκκίνηση του υποσυστήματος.
	\item Οι διαφορετικοί τύποι μεταβλητών των παραμέτρων (\mintinline{cpp}{uint16_t}, \mintinline{cpp}{uint32_t}, \mintinline{cpp}{float} κ.ά.) δημιουργούν δυσκολίες στη διαχείριση σε περιβάλλοντα με ασφαλείες τύπους (\e{type-safe}) όπως αυτό της C++, και ίσως κριθεί απαραίτητη η χρήση πιο "ανασφαλών" δομών.
