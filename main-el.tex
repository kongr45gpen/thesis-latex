...
\begin{figure}
	...
	\caption{Ανθεκτικότητα σύνθετου συστήματος σε μόνιμες βλάβες (θεωρώντας ευάλωτο ψηφοφόρο)}
...
Για απλοποίηση της ανάλυσης, θα θεωρήσουμε ότι στο χρονικό διάστημα που ορίζεται από την παράμετρο \( λ \) μπορεί να συμβεί μόνο 1 βλάβη. Αυτή η υπόθεση είναι ασφαλής, καθώς στα χρονικά διαστήματα που μελετάμε (συνήθως δευτερόλεπτα), είναι υπερβολικά ασυνήθιστο να συμβούν περισσότερες από 1 βλάβες.
\begin{equation}
P = P(X) = λe^{-λ}
\end{equation}
