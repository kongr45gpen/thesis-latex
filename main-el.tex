...
Να σημειωθεί πως δεν έχει γίνει καμία προσπάθεια για βελτιστοποίηση της κατανάλωσης μνήμης ή γενικότερα των επιδόσεων του συστήματος. Επίσης, να τονιστεί πως λόγω της χρήσης της βιβλιοθήκης \acs{ETL} και της έλλειψης δυναμικής κατανάλωσης μνήμης, οι καταναλώσεις του \Cref{tab:ramusage} αναφέρονται στην πλειοψηφία σχεδόν της κατανάλωσης μνήμης \acs{RAM}. Μάλιστα, ο σωρός (heap) όπου αρχικοποιούν μεταβλητές οι διεργασίες του FreeRTOS, είναι καταχωρημένος εξ' ολοκλήρου στο αρχείο \texttt{heap\_4.c}.
...
\begin{figure}[h]
	...
	\includegraphics{media/screenshots/yamcs_mcustart}
\end{figure}
...
\paragraph{\texttt{F-010}: Προσωρινή απώλεια λειτουργικότητας}
...
\begin{figure}[h]
	...
	\caption{Πίνακας μετάβασης ορισμών παρακολούθησης, μετά από την αποτυχία \texttt{F-010} (όπως φαίνεται στην διεπαφή \acs{PUS}}
...
\begin{table*}[h]
	...
	\begin{tabularx}{\linewidth}{@{}S[table-format=4.0]c@{\hskip 3em}rcl@{\hskip 3em}X@{}}
		\toprule
		Χρόνος (ms) & PMON & \multicolumn{3}{c}{Παράμετρος} & Μετάβαση \\ \midrule
...
Μετά από την αλλαγή των τιμών των παραμέτρων, σειρά έχει η υπηρεσία \emph{\texttt{ST[12]} on-board monitoring} και οι ορισμοί παρακολούθησης (\Cref{fig:pusf010tran,tab:f010tran}). 


%2442576 [debug  ] T [T1]: 25.56
%2442676 [debug  ] T [T2]: 25.56
%2442706 [error  ] Error in TWI: 1
%2442706 [debug  ] T [T1]: 0.00
%2442807 [debug  ] T [T2]: 25.56
%2442836 [error  ] Error in TWI: 1
%2442836 [debug  ] T [T1]: 0.00
%2442938 [debug  ] T [T2]: 25.63
%2442967 [error  ] Error in TWI: 1
%2442967 [debug  ] T [T1]: 0.00
%2443000 [error  ] Monitoring status 4 changed from 0 to 2
%2443000 [error  ] Monitoring status 6 changed from 0 to 2
%2443001 [error  ] Monitoring status 7 changed from 0 to 2
%2443002 [error  ] Monitoring status 9 changed from 0 to 2
%2443002 [error  ] Monitoring status 10 changed from 0 to 2
%2443003 [trace  ] New TM [3,25]
%Received TM [25]
%2443069 [debug  ] T [T2]: 25.63
%2443097 [error  ] Error in TWI: 1
%2443097 [debug  ] T [T1]: 0.00
%2443155 [trace  ] New TM [12,12]
%Received TM [82]
%2443200 [debug  ] T [T2]: 25.56
%2443228 [error  ] Error in TWI: 1
%2443228 [debug  ] T [T1]: 0.00
%2443331 [debug  ] T [T2]: 25.56
%2443359 [error  ] Error in TWI: 1
%2443359 [debug  ] T [T1]: 0.00
