...
\subparagraph{Οπτική ένδειξη} Η ενδεικτική λυχνία αναβοσβήνει μία φορά, και παραμένει ανοιχτή.
...
\subparagraph{Οπτική ένδειξη} Η ενδεικτική λυχνία αναβοσβήνει μια φορά, παραμένει ανοιχτή, και μετά σβήνει μόνιμα.

\subparagraph{Αποτελέσματα}

\begin{table*}[h]
	\centering
	\caption[][10pt]{Πίνακας μετάβασης ορισμών παρακολούθησης (αποτυχία \texttt{F-020})}
	\label{tab:f020tr}
	\begin{tabularx}{\linewidth}{@{}S[table-format=1.1]c@{\hskip 3em}rcl@{\hskip 3em}X@{}}
		\toprule
		Χρόνος (s) & PMON & \multicolumn{3}{c}{Παράμετρος} & Μετάβαση \\ \midrule
		0 & 4 & Θερμ. 1 & = & 0 & \ok \ar \invalid \\
