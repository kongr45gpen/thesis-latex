...
\renewcommand{\maketitle}{%
	...
	\begin{fullwidth}
		\vfill
		\begin{center}
			\href{https://www.auth.gr/}{\includegraphics[width=.8\textwidth]{auth_logo_text_el}}\par
			\vspace{1cm}
			...
			{\large 28 Ιουνίου 2021}\\[4cm] % Date
...
%\begin{textblock*}{5cm}(14.8cm,-1.6cm)
%	\includegraphics[angle=130,origin=c]{doty}
%\end{textblock*}
...
\begin{fullwidth}
	...
	\begin{minipage}{107mm}
		\justify
		\g{Το διάστημα δεν είναι ένα φιλόξενο περιβάλλον; αν και η σημερινή τεχνολογία έχει επιτρέψει τη λειτουργία χιλιάδων τεχνητών δο\-ρυ\-φό\-ρων σε τροχιά γύρω από τη γη, οι νανοδορυφόροι που χαρακτηρίζονται ως }“CubeSats”\g{ έχουν ένα ποσοστό αποτυχίας κοντά στο 50\%. Τα χαμηλά κόστη, η έλλειψη αυστηρών τεχνικών προδιαγραφών και η έλλειψη ανοιχτής τεχνικής βιβλιογραφίας συχνά αυξάνει τα ρίσκα για τα εκπαιδευτικά, επιστημονικά και εμπορικά \e{CubeSat}. Αυτή η εργασία ερευνά μία απλή παραμετροποιήσιμη αρχιτεκτονική Ανίχνευσης, Απομόνωσης και Αντιμετώπισης Βλαβών (\e{“FDIR”}) που βασίζεται σε Ευρωπαϊκά πρότυπα και πρωτόκολλα, ευρέως χρησιμοποιούμενα στον τομέα της αεροδιαστημικής. Αυτή η δομή διόρθωσης σφαλμάτων, μαζί με τη συνοδευόμενη υλοποίηση σε κώδικα, μπορεί να χρησιμοποιηθεί από οποιαδήποτε αποστολή \e{CubeSat} για να αυξηθεί η αξιοπιστία του σχεδιασμού και να μειωθεί η πιθανότητα αποτυχίας, μέσω της αυτόνομης αντιμετώπισης βλαβών κατά την πτήση. Η εργασία επίσης περιλαμβάνει γενικές πληροφορίες σχετικά με την αξιοπιστία των \e{CubeSat}, και εξερευνά το λογισμικό και υλικό που χρησιμοποιείται για να υλοποιηθεί το προτεινόμενο \e{FDIR} στην αποστολή \e{AcubeSAT}, η οποία βρίσκεται υπό σχεδιασμό από φοιτητές του Αριστοτελείου Πανεπιστημίου Θεσσαλονίκης.}
	\end{minipage}
\end{fullwidth}
...
\g{%
Κατ' αρχάς, θα ήθελα να ευχαριστήσω τον Καθηγητή Αλκιβιάδη Χατζόπουλο, όχι μόνο για τη βοήθεια και τις ευκαιρίες που μου έχει προσφέρει, αλλά για τη διαρκή υποστήριξη που παρέχει στο πρότζεκτ του \e{CubeSat}, σε οργανωτικό και τεχνικό επίπεδο.
Επίσης, θα ήθελα να ευχαριστήσω τους δεκάδες συμφοιτητές μου στο πρότζεκτ, και ιδιαίτερα στο υποσύστημα \e{OBC}, για τη συνεργασία και το έργο που έχουν προσφέρει και χρησιμοποιείται σε αυτήν τη διπλωματική. Η εργασία αυτή είναι αποτέλεσμα ενός φιλόδοξου πρότζεκτ που ξεκίνησε από το 2016 και έχει απασχολήσει έναν τεράστιο αριθμό φοιτητών, επιστημόνων και μηχανικών που πίστεψαν σε αυτό, από την Ελλάδα αλλά ακόμα και από την υπόλοιπη Ευρώπη, παρά όλες τις δυσκολίες και εμπόδια που αντιμετωπίστηκαν. Τέλος, θα ήθελα να ευχαριστήσω τον Αναστάση Ρετσέλη για τη συνεργασία μας και τις ενδιαφέρουσες συζητήσεις στο κομμάτι του \e{Systems Engineering}, αλλά και όλους τους φίλους και τους γονείς μου που στάθηκαν κοντά μου όλα τα τελευταία χρόνια. Δεν θα βρισκόμουν εδώ χωρίς εσάς.
}

%Κατ' αρχάς, θα ήθελα να ευ
...
\begin{marginfigure}
	...
	\end{tikzpicture}
	\caption[Είδη δορυφόρων σε λειτουργία το 2018]{Είδη δορυφόρων σε λειτουργία το 2018 \autocite{wood_visualizing_all_2020}}
	\label{fig:satellite_types}
\end{marginfigure}

\g{Η παρούσα εργασία ασχολείται με την Αεροδιαστημική Μηχανική, και πιο συγκεκριμένα την τεχνολογία κατασκευής και χειρισμού δορυφόρων. Ο πρώτος τεχνητός δορυφόρος \e{``Sputnik 1''} εκτοξεύτηκε το έτος 1957, και μέχρι το 2021 έχουν εκτοξευτεί περίπου \SI{8900}{} δορυφόροι, από τους οποίους περίπου \SI{4000}{} είναι λειτουργικοί και σε τροχιά} \autocite{unionofconcernedscientists_satellite_database_2021,kelso_norad_twoline,wood_visualizing_all_2020}.
...
\begin{figure}
	...
	\caption[Ενεργοί δορυφόροι σε τροχιά γύρω από τη γη το 2021]{\g{Ενεργοί τε\-χνη\-τοί δορυφόροι σε τροχιά γύρω από τη γη το 2021. Κοντά στον πλανήτη βρίσκονται οι δορυφόροι Χαμηλής Γήινης Τροχιάς. Σε σταθερό υψόμετρο }\SI{35786}{\kilo\meter}\g{ βρίσκονται οι δορυφόροι Γεωστατικής τροχιάς, και ανάμεσά τους κινούνται οι δορυφόροι Μέσης Γήινης Τροχιάς }\autocite{agi:analyticalgraphics_satellite_viewer}.}
...
\begin{marginfigure}
	...
	\caption[Γραφική αναπαράσταση του δορυφόρου Jason-3]{\g{Γραφική αναπαράσταση του δορυφόρου} \href{https://www.flickr.com/photos/noaasatellites/16979948568}{Jason-3}. %Στην εικόνα διακρίνονται τα ηλιακά πάνελς, οι δύο κατευθυντικές κεραίες και η θερμική μόνωση του δορυφόρου.
	}
\end{marginfigure}

\g{Η ανάπτυξη διαστημικής τεχνολογίας παρουσιάζει έναν σημαντικό βαθμό δυσκολίας, ο οποίος προέρχεται από τις ιδιαίτερα αυξημένες απαιτήσεις αξιοπιστίας στις δυσμενείς συνθήκες του διαστήματος. Πιο συγκεκριμένα, η μεγάλη απόσταση, οι ακραίες θερμοκρασίες, τα μηχανικά φορτία της εκτόξευσης, οι ακτινοβολίες υψηλών ενεργειών, το κενό αέρα,  και η αδυναμία αποκατάστασης βλαβών, έχουν εγείρει ένα ευρύ φάσμα προκλήσεων μπροστά στην ε\-ξε\-ρεύ\-νη\-ση του διαστήματος. Έτσι, πέρα από την τυπική ανάπτυξη τεχνολογίας, τα πρότζεκτ αεροδιαστημικής συνδέονται αναπόσπαστα με ένα σύνολο κλάδων της μηχανικής, όπως το} systems engineering (μηχανική συστημάτων), product assurance (διασφάλιση ποιότητας), reliability engineering (αξιοπιστία συστημάτων) και ζητήματα assembly, integration \& \acs{verification} (κατασκευής, συναρμολόγησης και επαλήθευσης) \autocite{smad}. Η παρούσα εργασία εστιάζει στο κομμάτι \acf{FDIR}, δηλαδή στη δυνατότητα των διαστημικών συστημάτων να εντοπίζουν και να ανακάμπτουν αυτόματα από σφάλματα και λειτουργικές αστοχίες.\acusepage{reliability}

Παρά τις προαναφερθείσες δυσκολίες, η τεχνολογία έχει προχωρήσει αρκετά ώστε το διάστημα να αποτελεί έναν εμπορικό στόχο. Στα πλαίσια της φιλοσοφίας "NewSpace", όλο και περισσότεροι κερδοσκοπικοί ή μη φορείς εκμεταλλεύονται τις δυνατότητες που προσφέρονται έξω από τη γη \autocite{denis_new_space_2020}. Start-ups, αστερισμοί δορυφόρων, εκπαιδευτικές αποστολές και εμπορικές υπηρεσίες είναι έννοιες που ήδη έγιναν συνηθισμένες τη δεκαετία του 2010, με περισσότερες χώρες ανά τον κόσμο να αρχίζουν όχι μόνον να έχουν πρόσβαση στο διάστημα, αλλά και να αποκτούν δυνατότητα \g{εκτόξευσης}.
...
\begin{marginfigure}
	...
	\end{tikzpicture}
	\caption[\g{Κατάσταση αποστολών \e{CubeSat} από το 2000 }]{\g{Κατάσταση αποστολών \e{CubeSat} από το 2000 }\autocite{swartwout_cubesat_mission_2019}}
...
\begin{marginfigure}
	...
	\end{tikzpicture}
	\caption[Κατάσταση αποστολών CubeSat από ανεξάρτητους κατασκευαστές]{Κατάσταση αποστολών CubeSat από ``hobbyists'' (\g{πανεπιστήμια και άλλα ερευνητικά/εκπαιδευτικά πρότζεκτ}) \autocite{swartwout_cubesat_database_2021}}
	\label{fig:cubesat_status_hobbyist}
\end{marginfigure}

Η παρούσα εργασία αφορά τη βελτίωση της \textbf{αξιοπιστίας}\g{ των νανοδορυφόρων και συστημάτων \e{CubeSat}. Αν και η πλειοψηφία των κλασικών δορυφόρων που έχουν εκτοξευτεί είχαν, έστω μερικώς, επιτυχημένες αποστολές }\autocite{kattakuri_failures_spacecraft_2019,jacklin_smallsatellite_mission_2019}, το 39.6\% των εκτοξευμένων CubeSats έχουν αποτύχει να ολοκληρώσουν την αποστολή τους, ή δεν έχουν λειτουργήσει σε τροχιά. Το ποσοστό αποτυχίας αυξάνεται στο 57.0\%\g{ αν εστιάσουμε σε φορείς (όπως Πανεπιστήμια) που εκτοξεύουν τα πρώτα τους }CubeSat, και δεν διαθέτουν την τεχνογνωσία των μεγάλων κατασκευαστών και διαστημικών υπηρεσιών.

\g{Οι λόγοι της υψηλής αποτυχίας των \e{CubeSat} σχετίζονται κυρίως με το συμπιεσμένο πρόγραμμα κατασκευής, το οποίο οδηγεί σε σφάλματα και προβλήματα που δεν εντοπίζονται κατά τη διάρκεια του σχεδιασμού. Πηγές βλαβών όπως περιβαλλοντική φθορά (θερ\-μι\-κοί κύκλοι, ακτινοβολία), έλλειψη περιθωρίων ασφαλείας στην ισχύ και τις τηλεπικοινωνίες, και προβλήματα λογισμικού, συνδυάζονται με τη γενικότερη έλλειψη εμπειρίας και αυστηρών διαδικασιών των νέων κατασκευαστών, για να μειώσουν το βαθμό αξιοπιστίας των νανοδορυφόρων }\autocite{swartwout_cubesat_mission_2019,langer_reliability_estimation_2017}.
...
Η παρούσα εργασία σκοπεύει να εμπλουτίσει την εργαλειοθήκη των κατασκευαστών CubeSat αναλύοντας μία δομημένη προσέγγιση \ac{FDIR} που βασίζεται στα \textbf{ευρωπαϊκά πρότυπα \acs{ECSS}}, και στην εργασία της πρωτοβουλίας \textbf{\acs{SAVOIR}}\footurl{https://savoir.estec.esa.int/}\g{ της ευρωπαϊκής διαστημικής βιομηχανίας. Στις επόμενες σελίδες, θα αναλυθεί πως οι ιδέες αυτές μπορούν να προσαρμοστούν σε μία αποστολή \e{CubeSat} μικρού βεληνεκούς ώστε:}
\begin{itemize}
	...
	\item Να αναπτυχθεί μία \textbf{παραμετροποιήσιμη} αρχιτεκτονική, που θα επιτρέπει τους \aclp{operator} να μεταβάλλουν εύκολα τη συμπεριφορά του συστήματος \acs{FDIR} και να το προσαρμόσουν σε διαφορετικά δεδομένα
\end{itemize}

Το προτεινόμενο σύστημα \acs{FDIR} στοχεύει στην αύξηση της βεβαιότητας κατά την κατασκευή, αλλά και στη γρήγορη ενσωμάτωση νέων δεδομένων που προκύπτουν κατά τις δοκιμές και την εκτόξευση.
...
Η εργασία ξεκινάει με την περίληψη της αποστολής AcubeSAT, που αποτελεί την κύρια αφορμή και πλαίσιο συγγραφής της (\Cref{cap:acubesat}). Συνεχίζει με μία ανάλυση των κύριων προτύπων και της φιλοσοφίας \acs{FDIR}\g{, με εστίαση στα κομμάτια που αφορούν τους κατασκευαστές \e{CubeSat} και τις ερευνητικές ή εκπαιδευτικές αποστολές }(\Cref{cap:savoir}). Το επόμενο κομμάτι εξετάζει την εφαρμογή των προηγούμενων προτύπων στο σχεδιασμό του AcubeSAT, και σε μερικές σχεδιαστικές αποφάσεις και λεπτομέρειες υλοποίησης του \acs{FDIR} στο νανοδορυφόρο (\Cref{cap:acufdir}).
...
Το πρότζεκτ ξεκίνησε σε ερευνητική μορφή το 2016, και το 2020 έγινε μέρος του προγράμματος \foothref{https://www.esa.int/Education/CubeSats_-_Fly_Your_Satellite}{``Fly Your Satellite! 3''} του Ευρωπαϊκού Οργανισμού Διαστήματος (European Space Agency), με ορίζοντα εκτόξευσης το 2023.
...
\g{Το πρότζεκτ είναι ανοιχτού κώδικα, με το λογισμικό και τις κατασκευές που έχει ετοιμάσει οι ομάδα να βρίσκονται σε ανοιχτά αποθετήρια για ελεύθερη χρήση από το κοινό.\e{\footurl{https://gitlab.com/acubesat/}}}

\section{Η αποστολή}


\g{Η κύρια αποστολή του \e{AcubeSAT} είναι η μελέτη ευκαρυωτικών κυττάρων σε Χαμηλή Γήινη Τροχιά, και πιο συγκεκριμένα η εκτίμηση των αποτελεσμάτων της \emph{ακτινοβολίας} και \emph{μικροβαρύτητας} σε 190 διαφορετικά στελέχη του ζυμομύκητα }\emph{Saccharomyces Cerevisiae}. Τα προηγούμενα επιτυγχάνονται με μία πρωτότυπη διάταξη "lab-on-a-chip", η οποία στο κέντρο της έχει ένα τσιπ \textbf{μικρορευστομηχανικής} (\Cref{fig:microfluidic_chip}) \autocite{volpetti_microfluidic_biodisplay_2017} που επιτρέπει την εξέταση της ρύθμισης της μοριακής συμπεριφοράς των κυττάρων σε πρωτοφανή κλίμακα.

Τα αποτελέσματα του πειράματος μεταφέρονται στη Γη σε μορφή φωτογραφιών, στις οποίες διακρίνεται το σύνολο των κυττάρων επάνω στο τσιπ μικρορευστομηχανικής, και εξάγονται αποτελέσματα ανάλογα με το \textbf{επίπεδο φθορισμού} που παράγεται στον κάθε θάλαμο. Τα αποτελέσματα σε τροχιά συγκρίνονται με ένα όμοιο επίγειο πείραμα αναφοράς.
...
Ο νανοδορυφόρος AcubeSAT\g{ είναι τεχνικά και οργανωτικά χωρισμένος σε 11 διαφορετικές υποομάδες ή \textbf{υποσυστήματα}, κάθε μία από τις οποίες είναι υπεύθυνη για ένα διαφορετικό τμήμα του δορυφόρου, και αποτελείται από \SIrange{2}{9}{} αφοσιωμένα μέλη.}
\begin{marginfigure}
...
Η υποομάδα του \ac{ADCS}\g{ είναι υπεύθυνη για τον έλεγχο του \textbf{προ\-σα\-να\-το\-λι\-σμού} του δορυφόρου σε τροχιά. Αυτό επιτυγχάνεται με τη χρήση μιας σειράς ενεργοποιητών, που προέρχονται έτοιμοι από την αγορά }(\ac{COTS}):\g{ μία πλακέτα μαγνητικών ενεργοποιητών 3 αξόνων και έναν τροχός αντίδρασης 1 άξονα, σε συνδυασμό με αισθητήρες για τον προσδιορισμό της περιστροφής του δορυφόρου (1 γυροσκόπιο και 2 μαγνητόμετρα) και αλγορίθμους φιλτραρίσματος \& ελέγχου }\autocite{DDJF_AOCS,velentzas_design_attitude_2021}.
...
\begin{enumerate}
	...
	\begin{marginfigure}
		...
		\caption{Σύστημα αναφοράς του AcubeSAT}
		\label{fig:frame}
	\end{marginfigure}
	\g{Η λειτουργία Σταθεροποίησης υλοποιείται με τον απλούστερο δυνατό τρόπο, χρησιμοποιώντας μόνο το ένα από τα 2 μαγνητόμετρα και έναν απλό αλγόριθμο ελέγχου. Ενεργοποιείται όταν δεν υπάρχει ανάγκη εφαρμογής κάποιου άλλου προφίλ, ή όταν η γωνιακή ταχύτητα του νανοδορυφόρου είναι επικίνδυνα υψηλή.}

	\item \textbf{Στόχευση στο Ναδίρ} (Nadir Pointing), όπου ο δορυφόρος \g{στρέ\-φει} την πλευρά \(+X\) (\Cref{fig:frame}) ώστε να κοιτάζει προς τη Γη. Αυτό το προφίλ χρησιμοποιείται σε περάσματα πάνω από τον Σταθμό Βάσης, όπου η κατευθυντική κεραία χρειάζεται άμεση ορατότητα.

	\item \textbf{Στόχευση στον Ήλιο} (Sun Pointing), όπου ο δορυφόρος \g{στρέφεται} προς τον ήλιο, προ\-κει\-μέ\-νου να μεγιστοποιηθεί η είσοδος των ηλιακών πάνελ. Αυτό το προφίλ χρησιμοποιείται ανάμεσα στα περάσματα από το Σταθμό Βάσης, ώστε να εξασφαλιστεί θετικός προϋπολογισμός ισχύος.
\end{enumerate}
...
\begin{itemize}
	...
	\item \textbf{\acf{TM}}:\g{ Πληροφορίες που αποστέλλονται από τον δορυφόρο προς τη Γη, που συνήθως περιλαμβάνουν ζωτικές πληροφορίες, όπως τιμές αισθητήρων, κατάσταση συστήματος, τρέχουσα ώρα και συμβάντα.}
	\item \textbf{Επιστημονικά δεδομένα}: Τα πειραματικά δεδομένα που παράγονται από το ωφέλιμο φορτίο (payload). Αυτά είναι τα δεδομένα με τον μεγαλύτερο όγκο και αντιπροσωπεύουν τα κύρια  αποτελέσματα της αποστολής.
\end{itemize}

\g{Είναι σημαντικό να αναφερθεί ότι η τροχιά του δορυφόρου επιτρέπει μόνο μια πολύ μικρή διάρκεια ορατότητας από τον Σταθμό Βάσης (\e{\acl{GS}}) κάθε μέρα, αυξάνοντας τις ανάγκες για αυτονομία και τη σημασία μιας σωστά εφαρμοσμένης μεθόδου \e{\acs{FDIR}}.}
...
Το \ac{EPS} είναι το υποσύστημα υπεύθυνο για την παραγωγή, κατανομή και αποθήκευση ηλεκτρικής ενέργειας στον δορυφόρο. Είναι ένα κρίσιμο κομμάτι του CubeSat, λόγω της άμεσης εξάρτησης και των σχετικά αυξημένων ενεργειακών αναγκών πολλών υποσυστημάτων του, και θεωρείται από τους πιο πιθανούς λόγους αποτυχίας των CubeSat σε τροχιά \parencite{langer_reliability_cubesats_2016,bouwmeester_survey_implementation_2017}.

Το AcubeSAT έχει επιλέξει έναν συνδυασμό από \ac{COTS} προϊόντα για το \ac{EPS} \autocite{DDJF_SYS}:
\begin{itemize}
	\item Τα \textbf{ηλιακά πάνελ} (solar panels) προμηθεύονται από την EnduroSat. 4 πάνελ διάστασης 3U καλύπτουν τις \(X\) και \(Y\) πλευρές, και ένα πάνελ 1U καλύπτει την \(-Z\) πλευρά.
	\item Η μονάδα \textbf{ελέγχου και διανομής ισχύος} (\acs{PCDU}) προμηθεύεται από την NanoAvionics\g{ και προσφέρει 10 προστατευμένα κανάλια με 4 διαφορετικές τιμές τάσης, καθώς και 4 μετατροπείς }\acs{MPPT}.
	\item Οι \textbf{μπαταρίες}, επίσης κατασκευασμένες από τη NanoAvionics, \g{αποτελούνται από 4 στοιχεία ιόντων λιθίου μορφής 18650.}
\end{itemize}
...
\marginnote{~} % Shift next reference a few ex
Το υποσύστημα \ac{OBDH} \g{είναι υπεύθυνο για το σχεδιασμό των διεπαφών δεδομένων του} CubeSat, \g{καθώς και για τον σχεδιασμό της πλακέτας} \textbf{\acf{OBC}}, \g{η οποία είναι επιφορτισμένη με τον έλεγχο των βασικών λειτουργιών του δορυφόρου} \parencite{DDJF_OBDH}.

Η πλακέτα \ac{OBC} περιέχει τα βασικά εργαλεία για την εξασφάλιση της αυτονομίας, και βασίζεται σε έναν ανθεκτικό στην ακτινοβολία μικροελεγκτή \foothref{https://www.microchip.com/wwwproducts/en/SAMV71Q21RT}{Microchip SAMV71Q21RT}, και μια μνήμη \acs{MRAM} που χρησιμοποιείται για την αποθήκευση κρίσιμων δεδομένων. \g{Η πλακέτα φιλοξενεί επίσης τον μικροελεγκτή του υποσυστήματος }\ac{ADCS}, ως μέτρο εξοικονόμησης χώρου.

\begin{marginfigure}
	\centering
	\includegraphics[width=.7\textwidth]{SAMV71Q21RT}
	\caption{Ο \acl{microcontroller} \texttt{SAMV71Q21RT}}
	\label{fig:samv71}
\end{marginfigure}

Η \acl{interface} δεδομένων μεταξύ των υποσυστημάτων του AcubeSAT χρησιμοποιεί ένα \ac{CAN} bus σε \textbf{ψυχρό πλεονασμό} (cold redundancy), το οποίο επιλέχθηκε λόγω της υψηλής αξιοπιστίας του \autocite{bouwmeester_survey_implementation_2017}. Οι πλακέτες του AcubeSAT ικανοποιούν τις μηχανικές απαιτήσεις του προτύπου PC/104 \autocite{PC104}.
...
\begin{itemize}
	...
	\item \textbf{Ασφαλής Λειτουργία} (Safe mode): Συνηθίζεται τα διαστημικά συστήματα να περιλαμβάνουν μια \emph{ασφαλή λειτουργία} \autocite[385]{aguirre_introduction_space_2013}\g{, όπου ο δορυφόρος απενεργοποιεί όλα τα μη απαραίτητα συστήματα και διαδικασίες, προκειμένου να ανταποκριθεί σε σημαντικές δυσλειτουργίες που δεν μπορούν να διορθωθούν αυτομάτως. Η ασφαλής λειτουργία προορίζεται ως μια καλά καθορισμένη και καλά δοκιμασμένη λειτουργία, η οποία είναι εύκολη στη συντήρηση και μειώνει τον κίνδυνο οποιασδήποτε καταστροφικής βλάβης.}
\end{itemize}
...
\begin{itemize}
	\item Την ανάλυση και διαμόρφωση του \ac{COTS} σκελετού 3U (\Cref{fig:structure}) \g{που στεγάζει όλα τα εξαρτήματα του \e{CubeSat} και είναι κατασκευασμένος από αλουμίνιο. Οι αναλύσεις δονήσεων είναι ιδιαίτερα σημαντικές, καθώς διερευνούν κατά πόσο το \e{CubeSat} μπορεί να αντέξει τα μηχανικά φορτία κατά την εκτόξευση.}
...
Η υποομάδα του \acl{SYE} \g{λειτουργεί ως τεχνική αρχή του δορυφόρου. Είναι υπεύθυνη για το συντονισμό των εργασιών και της επικοινωνίας μεταξύ των υποσυστημάτων, τη συμμόρφωση με τα πρότυπα και τις τεχνικές \aclp{requirement}, καθώς και τον εντοπισμό \& την επίλυση όλων των ζητημάτων που προκύπτουν από τον πολύπλοκο σχεδιασμό ενός δορυφορικού συστήματος.}
...
\begin{compactitem}
	...
	\begin{marginfigure}
		...
		\label{fig:container}
	\end{marginfigure}
	\item Ένα \textbf{τσιπ μικρορευστομηχανικής} (microfluidic chip) βασισμένο στο υλικό \acs{PDMS}, που φιλοξενεί 384 θαλάμους ικανούς να εξετάσουν 190 διαφορετικά στελέχη του μύκητα \emph{Saccharomyces Cerevisiae} για κάθε υποπείραμα.
	\item Ένα \textbf{υδραυλικό σύστημα} που αποτελείται από 2 αντλίες, 14 ηλεκτρικές βαλβίδες και 3 σακούλες υγρών.
	\item Ένα \textbf{οπτικό σύστημα} που λειτουργεί ως μικροσκόπιο, περιέχοντας μια κάμερα και μια σειρά από λαμπτήρες, φίλτρα και ένα φακό.
...
\g{Η υποομάδα \e{Trajectory} είναι υπεύθυνη για την ανάλυση της τροχιάς του διαστημικού σκάφους, την αποτίμηση των επιπτώσεων της ακτινοβολίας, τη συμμόρφωση του δορυφόρου με τους κανονισμούς για τα διαστημικά σκουπίδια και την εκτίμηση της διάρκειας ζωής του σε τροχιά.}

\begin{figure}
	\includegraphics{GmatScreenShot_002}
	\caption[Επίγειο ίχνος μιας πιθανής τροχιάς του AcubeSAT]{Επίγειο ίχνος μιας πιθανής τροχιάς του AcubeSAT, σχεδιασμένο με χρήση του εργαλείου \acs{GMAT} της NASA \autocite{nasa_general_mission}}
	\label{fig:gmat}
\end{figure}
...
Η δεύτερη φιλοσοφία βασίζεται στο εγχειρίδιο \textbf{\texttt{SAVOIR-HB-003} \linebreak[4]"\acs{SAVOIR} \acs{FDIR} Handbook"} \autocite{SAVOIR-HB-003} της πρωτοβουλίας \textbf{\acf{SAVOIR}}. Το εγχειρίδιο αυτό βασίζεται στις λειτουργίες του προτύπου \texttt{ECSS-E-ST-70-41C}, και προτείνει μία λεπτομερή μεθοδολογία για την ανάπτυξη του \ac{FDIR} σε ένα διαστημικό πρότζεκτ. \g{Το εγχειρίδιο είναι \textbf{η βάση της φιλοσοφίας} που ακολουθείται στη συνέχεια της εργασίας.}
...
\marginnote{%
	...
	\textbf{Γεγονός}\acuse{event} (event): Αξιοσημείωτο συμβάν που λαμβάνει χώρα στο δορυφόρο, όπως:
	\begin{compactitem}
	...
	\textbf{Παράμετρος}\acuse{parameter} (parameter): Μεταβλητός και αναγνώσιμος περιέκτης δεδομένων που μπορεί να αντιπροσωπεύει:
	\begin{itemize}
...
\begin{compactitem}
	...
	\g{Παρέχει αναφορές επιβεβαίωσης ή αποτυχίας για εκτελούμενες εντολές. Αυτή η υπηρεσία ουσιαστικά ενημερώνει τους \aclp{operator} για την (επιτυχημένη ή μη) κατάσταση των \e{\ac{TC}} που αποστέλλονται στον δορυφόρο.}
	...
	\item \textbf{\texttt{ST[03]}: Housekeeping}
		...
		\g{Επιτρέπει την αναφορά στατιστικών στοιχείων (ελάχιστο, μέγιστο, μέσος όρος, τυπική απόκλιση) για παραμέτρους σε καθορισμένα χρονικά διαστήματα.}

		\item \textbf{\texttt{ST[05]}: Event reporting}

		Ενημερώνει τους \aclp{operator} όταν λαμβάνουν χώρα γεγονότα.
		...
		\item \textbf{\texttt{ST[10]}: Time packet} \emph{(καταργημένη)}
		...
		Επιτρέπει στους \aclp{operator} να προγραμματίζουν (``time-tag'') \g{τηλεεντολές για εκτέλεση σε μελλοντικές χρονικές στιγμές, αντί για αμέσως.}

		\item \textbf{\texttt{ST[12]}: On-board monitoring}

		\g{Επιτρέπει τον έλεγχο των τιμών των παραμέτρων για να διασφαλιστεί ότι παραμένουν εντός ρυθμιζόμενων ορίων. Κάθε φορά που τα όρια παραβιάζονται, δημιουργείται ένα \acl{event} (\e{\texttt{ST[05]}}) για περαιτέρω επεξεργασία.}
		...
		\g{Επιτρέπει την αποθήκευση των παραγόμενων αναφορών, καθώς και την ανάκτησή τους όταν ο δορυφόρος διέρχεται επάνω από το Σταθμό Βάσης.}

		\item \textbf{\texttt{ST[16]}: On-board traffic management}  \emph{(καταργημένη)}
		...
		\g{Επιτρέπει τη φόρτωση, τον έλεγχο (εκκίνηση, αναστολή, συνέχιση, διακοπή) και τη ρύθμιση των \e{``operations procedures''}, δηλ. ακολουθιών εντολών σε κάποια ερμηνευμένη γλώσσα προγραμματισμού.}

		\item \textbf{\texttt{ST[19]}: Event-action}\acusepage{event-action}
		...
		Επιτρέπει στους \aclp{operator} να φορτώνουν \acp{TC} για να εκτελεστούν με διαδοχική σειρά.
...
Το εγχειρίδιο \texttt{SAVOIR-HB-003} \g{περιγράφει με λεπτομέρεια τη διαδικασία και μεθοδολογίες για εφαρμογή του \e{\acs{FDIR}}, βασισμένο σε αποτελέσματα \& διδάγματα από προηγούμενες ευρωπαϊκές αποστολές. Σε αυτό το κεφάλαιο θα σχολιαστούν τα κομμάτια που αφορούν μία αποστολή} CubeSat χαμηλού κόστους.

\subsection{Βήματα σχεδιασμού \acs{FDIR}}
Το εγχειρίδιο αναλύει τα βήματα του σχεδιασμού του \acs{FDIR}\g{, άρρηκτα συνδεδεμένα με τις φάσεις μιας τυπικής διαστημικής αποστολής. Έχει σημασία να τονιστεί πως ο σχεδιασμός του }\acs{FDIR}\g{ ξεκινάει πριν την υλοποίηση και επαλήθευσή του, από γενικό σε πιο λεπτομερές επίπεδο. Αυτή η λογική \e{``κα\-ταρ\-ρά\-κτη''} που ακολουθείται από τα διαστημικά πρότζεκτ αντιτίθεται στην πιο σύγχρονη και ευέλικτη }``agile''\g{ λογική των πρότζεκτ μικρού βεληνεκούς. Παρ' όλα αυτά, οι ιδέες του εγχειριδίου μπορούν να εφαρμοστούν σε οποιαδήποτε λογική ανάπτυξης ενός πρότζεκτ.}

Τα βήματα της διαδικασίας \acs{FDIR} ορίζονται ως τα εξής:
\begin{enumerate}
	\setcounter{enumi}{-1}
	\item \textbf{Τεχνικές \aclp{requirement}} (requirements): \g{Εδώ, με βάση τις απαιτήσεις της κάθε αποστολής, αναλύονται αντίστοιχα οι απαιτήσεις του συστήματος για αξιοπιστία \& διαθεσιμότητα, και εξάγονται οι βασικές προδιαγραφές για το σύστημα} \acs{FDIR}. Σε αυτό το στάδιο δε λαμβάνονται σχεδιαστικές αποφάσεις και δεν επιλέγονται λύσεις, αλλά καθορίζονται τα προβλήματα που πρέπει να λυθούν και τα βασικά κριτήρια επιτυχίας του συστήματος.
	\label{itm:fdir_reqs}

	Αν και η διατύπωση τεχνικών προδιαγραφών σε τυχαία γεγονότα και βλάβες για τις οποίες δεν υπάρχει αρκετή διαθέσιμη πληροφορία είναι δύσκολη, το εγχειρίδιο προτείνει ένα σύνολο από τεχνικές προδιαγραφές \autocite[42]{SAVOIR-HB-003} που μπορούν να χρησιμοποιηθούν από αποστολές. Ένα μεγάλο σύνολο των προδιαγραφών αυτών πληρούται και από τη σχεδίαση που παρουσιάζουμε στις επόμενες ενότητες.
	...
	\label{itm:fdir_cdr}
	\item \textbf{Υλοποίηση \& \acl{verification}}: Σε αυτό το στάδιο κατασκευάζεται το υλικό και συγγράφεται το λογισμικό που εκτελούν το \acs{FDIR}. Ακόμα, για τα αντικείμενα της λίστας \acs{HSIA}, πραγματοποιείται \textbf{\acl{verification}} μέσω ανάλυσης ή δοκιμής. Πιο συγκεκριμένα, πρέπει να προσομοιωθεί ή κάθε επίφοβη \acl{failure} (feared event), και να επαληθευθεί πως το σύστημα μπορεί να την αντιμετωπίσει με αναμενόμενο τρόπο.
	\label{itm:fdir_valid}
	\item \textbf{Επικύρωση} (\acs{validation}): \g{Σε αυτό το στάδιο πραγματοποιούνται δοκιμές του \e{\acs{FDIR}} σε επίπεδο συστήματος, ως μέρος της δοκιμαστικής καμπάνιας\footnote{Μπορεί να περιέχει τις λειτουργικές δοκιμές συστήματος (\e{ambient tests}), ή τις δοκιμές περιβάλλοντος (\e{environmental tests}) όπου προσομοιώνονται συνθήκες διαστήματος} ολόκληρης της αποστολής, και πραγματοποιούνται οι τελικές μικρορυθμίσεις.}
...
\g{Αν και όλα τα παραπάνω βήματα έχουν σημασία, για "λιτές" αποστολές πρέπει να εστιαστεί προσοχή στις τεχνικές \aclp{requirement} (\Cref{itm:fdir_reqs}), στον ορισμό ιδέας (\Cref{itm:fdir_concept}), στον λεπτομερή σχεδιασμό (\Cref{itm:fdir_cdr}) και στην επαλήθευση (\Cref{itm:fdir_valid}). Ένα παράδειγμα εφαρμογής της παραπάνω διαδικασίας βρίσκεται στο \Cref{cap:practical}.}

Σε αυτό το σημείο θα πρέπει να τονιστεί πως η διαδικασία σχεδιασμού του \acs{FDIR} και γενικότερα της μελέτης αξιοπιστίας του συστήματος είναι κάτι που πρέπει να λαμβάνεται υπ' όψιν καθ' όλη τη διάρκεια σχεδιασμού ενός διαστημικού συστήματος, και όχι μόνο στον λεπτομερή σχεδιασμό ή στην επαλήθευση. Ο τομέας του \acf{RAMS} συνδέεται άμεσα με όλα τα υπόλοιπα υποσυστήματα, λαμβάνοντας τις απαραίτητες εισόδους αλλά και επηρεάζοντας σε μεγάλο βαθμό το σχεδιασμό. Ειδικότερα σε νέα CubeSat projects, ο τομέας της αξιοπιστίας τείνει να μη λαμβάνει τη δέουσα σημασία \autocite{langer_reliability_estimation_2017}. \acusepage{reliability}

\subsection{Προτεινόμενη αρχιτεκτονική}

Το εγχειρίδιο προτείνει κάποιες αρχές για την αρχιτεκτονική ενός συστήματος \acs{FDIR}\g{, η πρώτη από τις οποίες το εξετάζει ως ένα \textbf{ιεραρχικό} σύστημα, όπου μικρής σημασίας αποτυχίες ξεκινούν από \textbf{εσωτερικά εξαρτήματα} και διορθώνονται σε επίπεδο εξαρτήματος, ή διαδίδονται στο υπόλοιπο σύστημα και απαιτούν σημαντικότερες ενέργειες ανάκαμψης }(\Cref{fig:FDIR-levels}).

\begin{figure}
	\includegraphics{FDIR-levels}
	\caption[Προτεινόμενη ιεραρχία των διαφορετικών επιπέδων FDIR από το SAVOIR]{Προτεινόμενη ιεραρχία των διαφορετικών επιπέδων \acs{FDIR} από το \acs{SAVOIR}.\g{ Η κάθε αποστολή μπορεί να επιλέξει διαφορετικά επίπεδα για να απλοποιήσει την υλοποίηση του συστήματος.}}
	\label{fig:FDIR-levels}
\end{figure}

\g{Συνεχίζοντας, παρουσιάζεται μία \textbf{προσαρμόσιμη} υλοποίηση που εκμεταλλεύεται τη \textbf{βάση δεδομένων} του συστήματος και την επικοινωνία με τα} \textbf{\acs{PUS} services} \g{ώστε να καλυφθούν πλήρως οι ανάγκες του \e{\acs{FDIR}}. Η λογική αυτή προϋποθέτει τα ακόλουθα:}\acusepage{service}
\begin{compactenum}
	\item \g{Δεδομένα αξιοπιστίας αποθηκεύονται σε \textbf{παραμέτρους} (π.χ. τιμές αισθητήρων, κατάσταση περιφερειακών)}
	\item \g{Οι παράμετροι αυτές \textbf{παρακολουθούνται} από την υπηρεσία} on-board monitoring. \g{Όταν κάποια παράμετρος αποκτήσει τιμή εκτός ορίων, σημαίνει πως έχει εμφανιστεί κάποια \acl{failure}.}
	\item \g{Κάθε έξοδος από τα όρια δημιουργεί ένα \textbf{\acl{event}} που τηλεμετράται} (\acs{TM}) \g{στους \aclp{operator}.}
	\item \g{Κάθε \acl{event} είναι συνδεδεμένο με μία \textbf{αντίδραση}, αποθηκευμένη στην υπηρεσία} event-action.
...
Η παραπάνω λογική συνοψίζεται στο \Cref{fig:fdirpus}. Η σημασία της έγκειται στο ότι προσφέρει έναν \textbf{δομημένο} τρόπο το σύστημα να διαχειριστεί οποιοδήποτε πρόβλημα από αυτά που έχουν προβλεφθεί, αλλά ταυτόχρονα να δίνει τη δυνατότητα στους \aclp{operator} \& κατασκευαστές:
\begin{compactitem}
	...
	\item \g{Να χρησιμοποιήσουν μία έτοιμη και δοκιμασμένη σουίτα λογισμικού των υπηρεσιών \e{\acs{ECSS}} για να υλοποιήσουν όλα τα παραπάνω, μειώνοντας το κόστος και τον χρόνο ανάπτυξης.}
...
\begin{enumerate}
	...
	\item \textbf{Διαμορφωσιμότητα} σε τροχιά: \g{Είναι πολύ δύσκολο να προβλεφθεί από πριν η ακριβής συμπεριφορά του δορυφόρου σε τροχιά. Ως εκ τούτου, θα πρέπει να δίνεται η δυνατότητα στους \aclp{operator} για πλήρη διαμόρφωση και ρύθμιση του \e{\acs{FDIR}} αν χρειαστεί. Η διαμορφωσιμότητα αυτή μπορεί να περιλαμβάνει απενεργοποίηση ελέγχων, αλλαγές επικίνδυνων ορίων, ή ακόμα και εγκατάσταση νέων ελέγχων.}
	\item \textbf{Παρατηρησιμότητα}, προσφέροντας έναν μεγάλο όγκο πληροφορίας στο σταθμό βάσης για τη διάγνωση των προβλημάτων.
	\item \g{\textbf{Καμία υπόθεση} για λειτουργικότητα εξοπλισμού. Κάθε κατάσταση σφάλματος στο λογισμικό και κάθε μη έγκυρη είσοδος λογισμικού θα πρέπει να θεωρείται πιθανή.}
	\item \textbf{Διαθεσιμότητα}: Το AcubeSAT \g{επωφελείται από μεγαλύτερους χρόνους σε τροχιά, αφού αυτό επιτρέπει το κατέβασμα μεγαλύτερου όγκου δεδομένων και περισσότερα επιστημονικά αποτελέσματα.} Επιπλέον, σύντομη διακοπή κάποιου από τα υ\-πο\-πει\-ρά\-μα\-τα μπορεί εγγενώς να οδηγήσει σε πλήρη \acl{failure} του. Ως εκ τούτου, το AcubeSAT ακολουθεί μία \emph{λειτουργική} (fail-operational) και όχι \emph{ακίνδυνη} (fail-safe) λογική, και προσπαθεί να διορθώσει βλάβες χωρίς να διακόψει τη ροή των λειτουργιών του.
...
\begin{enumerate}[label=Επίπεδο \arabic*]
	...
	Το επίπεδο αυτό το αναλαμβάνει συνήθως ο \acl{microcontroller} του κάθε υποσυστήματος. \g{Παρ' όλο} που οι αποτυχίες εδώ μπορεί να μη γίνουν αντιληπτές από τα υπόλοιπα υποσυστήματα, η αντίστοιχη τηλεμετρία πρέπει να παραχθεί ώστε για να υπάρχει η κατάλληλη παρατηρησιμότητα από το σταθμό βάσης, ή να προβλεφθούν άλλες βλάβες που δεν έγιναν αντιληπτές από το δορυφόρο.
	...
	Οι αποτυχίες σε επίπεδο υποσυστήματος και πάνω αναλαμβάνονται από τον μικροελεγκτή του \acf{OBC}, που περιέχει το λογισμικό για τον εντοπισμό και επιδιόρθωσή τους. Σε περίπτωση όμως αποτυχίας του \acs{OBC}, το \acf{ADCS} αναλαμβάνει την ευθύνη του \acs{FDIR}.
	\item \g{\textbf{Σύστημα}: Εδώ ανήκουν αποτυχίες οι οποίες δεν μπορούν να διορθωθούν αυτόνομα από το σύστημα (π.χ. ελλιπής ισχύς, υπερβολικά μεγάλη γωνιακή ταχύτητα). Ο τρόπος επιδιόρθωσης εδώ είναι συνήθως η είσοδος σε \emph{ασφαλή λειτουργία}, όπου πραγματοποιούνται μόνο οι πιο βασικές και ζωτικές διαδικασίες του δορυφόρου, μέχρι το σφάλμα να επιδιορθωθεί από τον σταθμό βάσης.}
\end{enumerate}
...
\g{Προτού μελετήσουμε τη δομή του \e{\acs{FDIR}}, έχει νόημα να μελετήσουμε διαφορετικές αρχιτεκτονικές αποφάσεις που μπορούν να ληφθούν κατά το σχεδιασμό ενός μικρού δορυφορικού συστήματος. Πιο συγκεκριμένα, θα συγκρίνουμε τις δομές} \autocite{birolini_reliability_engineering_2004}:

\begin{enumerate}
	\item \textbf{Απλού εξαρτήματος}
	\item \textbf{Διπλού πλεονασμού}, όπου έχουμε δύο όμοια εξαρτήματα που πραγματοποιούν την ίδια λειτουργία, και το ένα μπορεί να αντικαταστήσει το άλλο. \g{Η συνδεσμολογία αυτή μπορεί να ακολουθεί με τη λογική του \textbf{ψυχρού πλεονασμού} ή του \textbf{ενεργού πλεονασμού}.}
	...
	Στον \textbf{ενεργό πλεονασμό}, \g{και τα δύο εξαρτήματα είναι λειτουργικά ταυτόχρονα, πραγματοποιώντας τις ίδιες διαδικασίες, και το ένα εξάρτημα μπορεί να αναλάβει τις λειτουργικές ευθύνες σε περίπτωση βλάβης του άλλου.}

	\item \textbf{Τριπλού πλεονασμού με ψηφοφορία} (triple modular redundancy), \g{όπου έχουμε τρία εξαρτήματα που πραγματοποιούν συνεχώς τους ίδιους υπολογισμούς, και ένα κύκλωμα ψηφοφορίας επιλέγει την έξοδο που έχει την πλειοψηφία από τα 3 εξαρτήματα.}
\end{enumerate}
...
\end{marginfigure}
\begin{itemize}
	\item \g{Στις \textbf{μόνιμες βλάβες} εξετάζουμε συμβάντα (π.χ. ακτινοβολία, απώλεια μνήμης) τα οποία δεν μπορούν να διορθωθούν και οδηγούν σε απώλεια της αποστολής. Η μελέτη εδώ γίνεται με βάση την έννοια της αξιοπιστίας (\e{reliability}) \( R(t) \), δηλαδή της πιθανότητας το σύστημα να επιζήσει εντός μιας χρονικής περιόδου \( t \).}
	\item Στις \textbf{προσωρινές βλάβες} εξετάζουμε συμβάντα (π.χ. αλλαγές bit, bugs \g{λογισμικού, λάθη στη μεταφορά μηνυμάτων) που είναι παροδικά και επηρεάζουν συνήθως μόνο μία μέτρηση, μία ενέργεια ή ένα αποτέλεσμα. Εδώ η μελέτη γίνεται με βάση την έννοια του ρυθμού βλαβών (\e{failure rate}) \( \lambda \), δηλαδή της συχνότητας των αποτυχιών.}
\end{itemize}
...
\marginnote{\g{Σε όλες τις αναλύσεις υποθέτουμε ότι τα πλεονάζοντα εξαρτήματα είναι πανομοιότυπα και έχουν τα ίδια χαρακτηριστικά αξιοπιστίας.}}
...
\begin{figure}
	...
	\caption[Ανθεκτικότητα σύνθετου συστήματος σε μόνιμες βλάβες (θεωρώντας αλάνθαστο ψηφοφόρο)]{\g{Ανθεκτικότητα σύνθετου συστήματος σε μόνιμες βλάβες (θεωρώντας αλάνθαστο ψηφοφόρο --- μεγαλύτερο \(R\) \g{είναι καλύτερο})}}
...
\begin{figure}
	...
	\caption[Ανθεκτικότητα σύνθετου συστήματος σε μόνιμες βλάβες (θεωρώντας ευάλωτο ψηφοφόρο)]{\g{Ανθεκτικότητα σύνθετου συστήματος σε μόνιμες βλάβες (θεωρώντας ευάλωτο ψηφοφόρο --- μεγαλύτερο \(R\) \g{είναι καλύτερο})}}
...
\g{Στον ενεργό διπλό πλεονασμό δεν είναι πάντα δυνατός ο εντοπισμός της λάθος και της σωστής εξόδου, επομένως μία βλάβη σε οποιοδήποτε από τα δύο εξαρτήματα θεωρείται βλάβη του συστήματος. Άρα, αν \(X_1\) και \(X_2\) τα ενδεχόμενα βλάβης του 1\textsuperscript{ου} και του 2\textsuperscript{ου} εξαρτήματος αντίστοιχα:}
\begin{align}
...
Η \eqref{eq:lambert_eqn} μπορεί να λυθεί αξιοποιώντας τη συνάρτηση \e{Lambert W} \e{\autocite{weisstein_lambert_wfunction_2003}} που ορίζεται ως εξής:
\begin{align}
...
\newthought{Στο συστημα} με τριπλό πλεονασμό, το ενδεχόμενο συνολικής αποτυχίας προκύπτει αν αποτύχουν τουλάχιστον 2 από τα εξαρτήματα. Άρα, αντίστοιχα με την \eqref{eq:tmr}:
\begin{align}
P_3 &= 3P^2 - 2P^3 \nonumber\\
...
\g{Τα αποτελέσματα των παραπάνω μπορούν να υπολογιστούν αριθμητικά και φαίνονται στο \Cref{fig:reliability_repair}.}
...
\begin{table*}[h]
	\centering
	\caption[][10pt]{\g{Τρόποι εντοπισμού αποτυχιών \e{\acs{FDIR}} του \e{AcubeSAT}}}
	...
	\begin{tabularx}{\textwidth}{@{}cL{5cm}X@{}}
		...
		Μονάδα & \textbf{Καμία απάντηση ή ασυνάρτητες τιμές} & Η μονάδα ή η \acl{interface} μπορεί να είναι ελαττωματική. \\
		...
		Λογισμικό & \textbf{Αποτυχημένος έλεγχος ορισμάτων} & \texttt{assert} \\
...
\begin{table*}[h]
	...
	\begin{tabularx}{\textwidth}{@{}lcX@{}}
		...
		20 & Διαχειριστικά & Αξιολόγηση των διαθέσιμων πόρων \& προϋπολογισμών πριν από την έναρξη \g{υποπειράματος} \\ \bottomrule
	\end{tabularx}
\end{table*}
...
\begin{table*}[h]
	...
	\begin{tabularx}{\textwidth}{@{}lL{3cm}X@{}}
		...
		Σύστημα & \textbf{\g{Είσοδος σε ασφαλή λειτουργία} (safe mode)} & Αυτό είναι το τελευταίο βήμα στις διορθωτικές προσπάθειες. Ο δορυφόρος εισέρχεται στην ασφαλή λειτουργία ώστε να αποτρέψει περαιτέρω διάδοση της βλάβης. \\ \bottomrule
	\end{tabularx}
\end{table*}
\acusepage{isolation}
\acusepage{recovery}
...
\g{Μετά από την επιδιόρθωση (ή προσπάθεια επιδιόρθωσης) της βλά\-βης, η ευθύνη μεταφέρεται πλέον στους \aclp{operator}, που πρέπει να εντοπίσουν την βασική πηγή του προβλήματος, και να πραγματοποιήσουν τις απαραίτητες ενέργειες, αν χρειάζεται, για τη μόνιμη επιδιόρθωσή του.}
...
\begin{enumerate}
	\item \g{Αν μια παρατηρούμενη παράμετρος είναι εκτός ορίων, πρώτα επιχειρείται επιδιόρθωση σε επίπεδο μονάδας με \textbf{απλές ενέργειες} (π.χ. }reset, επανεκκίνηση).
	...
	Σε αυτό το σημείο πρέπει να τονιστεί πως η απενεργοποιημένη μονάδα δεν μπορεί να συνεισφέρει σε οποιαδήποτε λειτουργία του δορυφόρου. Η υπηρεσία \texttt{ST[12]} επιτρέπει τη χρήση των \textbf{check validity conditions} \g{(συνθηκών εγκυρότητας ελέγχου), που μπορούν να απενεργοποιήσουν έναν έλεγχο αν αυτός αναφέρεται σε απενεργοποιημένη συσκευή ή άλλες συνθήκες που τον αποτρέπουν.}
...
\g{Όλα τα παραπάνω εκτελούνται στο υπόβαθρο του κάθε μικροελεγκτή σαν μία διεργασία του \e{\acs{RTOS}}, και, βασισμένα στις υπηρεσίες \e{\acs{PUS}}, είναι πλήρως προσαρμόσιμα από τον σταθμό βάσης.}
...
\g{Ο στόχος της ασφαλούς λειτουργίας είναι να παρέχει μια ισχυρή, καλά δοκιμασμένη και ντετερμινιστική κατάσταση, όπου ο δορυφόρος μπορεί να λειτουργήσει αυτόνομα, μέχρι οι \aclp{operator} μπορέσουν να αποκαταστήσουν την απειλητική για την αποστολή βλάβη. Το }\acs{FDIR}\g{ της Ασφαλούς Λειτουργίας ακολουθεί επίσης το πρότυπο }\acs{PUS} και τις προδιαγραφές του AcubeSAT (\Cref{sec:fdirbaspri})\g{, συνεχίζοντας να επιτρέπει τις αλλαγές από τους \aclp{operator}.}
...
\begin{itemize}
	\item Απενεργοποίηση ολόκληρων \textbf{προβληματικών} υποσυστημάτων. Στην περίπτωση των \acs{ADCS} και \acs{OBC}, \g{η ενέργεια αυτή συνοδεύεται από σημαντικά μειωμένη λειτουργικότητα, αλλά δεν επηρεάζει τη δυνατότητα ελέγχου του δορυφόρου. Από την άλλη πλευρά, η απενεργοποίηση των υποσυστημάτων \e{\acs{COMMS}} και \e{\acs{EPS}} εμποδίζει οποιαδήποτε επικοινωνία του σταθμού βάσης με το \e{CubeSat}. Η μόνη δράση που μπορεί να γίνει είναι η προσπάθεια επανεκκίνησης των υποσυστημάτων μετά από μία προκαθορισμένη χρονική καθυστέρηση, μέχρι ο δορυφόρος να βρεθεί για παράδειγμα σε πιο ευνοϊκές περιβαλλοντικές συνθήκες.}
	\item \g{Απομόνωση εξαρτημάτων και ανάλογη αναδιαμόρφωση των υποσυστημάτων. Ο μικρότερος αριθμός ενεργών εξαρτημάτων σε Ασφαλή Λειτουργία σημαίνει μια πιο ασφαλή διαδικασία σχεδιασμού και δοκιμών.}
\end{itemize}


Οι \aclp{operator} του AcubeSAT είναι υπεύθυνοι για τον προσδιορισμό της αιτίας της βλάβης και των διορθωτικών ενεργειών αμέσως μόλις λάβουν την τηλεμετρία που ανακοινώνει το σφάλμα, και πρέπει να επέμβουν άμεσα αφού αποφασιστεί μια ασφαλής πορεία δράσης. Η έξοδος από την ασφαλή λειτουργία μπορεί να γίνει \emph{μόνο μετά από εντολή του χειριστή}, και μόνο αφού διορθωθεί το αρχικό σφάλμα και δεν είναι ορατά άλλα σφάλματα (λόγω π.χ. διάδοσης της βλάβης). Οι δράσεις που μπορούν να λάβουν οι \aclp{operator} είναι:
\begin{compactitem}
	\item Αλλαγή των ρυθμίσεων του δορυφόρου μέσω των υπηρεσιών \acs{ECSS}
	\item \g{Πιο συχνά, αλλαγή του \textbf{λογισμικού} του δορυφόρου, ανεβάζοντας ανανεωμένες εικόνες δυαδικής μορφής\footnote{Η διαδικασία αυτή απαιτεί την εκτέλεση πλήρους καμπάνιας δοκιμών λογισμικού στη γη, και μία αξιόπιστη διαδικασία επαναπρογραμματισμού του δορυφόρου σε τροχιά \e{\autocite[45]{DDJF_OBSW}}}}
...
Η επαλήθευση του \acs{FDIR}\g{ είναι το τελευταίο κομμάτι της διαδικασίας, και περιλαμβάνει έλεγχο της κάθε επίφοβης αποτυχίας, μέσω προσομοίωσης με υλικό ή λογισμικό.}
...
\begin{compactitem}
	...
	\item \g{Έναν υπολογιστή, που χρησιμεύει ως \textbf{σταθμός βάσης} για την παροχή των απαραίτητων δυνατοτήτων ελέγχου και παρατήρησης.}
\end{compactitem}
...
\g{Προκειμένου να εξομοιώσουμε τις πιο βασικές λειτουργίες ενός υποσυστήματος διαστημικού σκάφους, υλοποιήσαμε ένα σύστημα με μία μόνο λειτουργική \acl{requirement}:}
\begin{quote}
	\texttt{RQ-010}: Το σύστημα πρέπει να μετρά και να μεταδίδει τη θερμοκρασία περιβάλλοντος.
\end{quote}

\g{Προκειμένου να δικαιολογήσουμε μια υλοποίηση \e{\ac{FDIR}} για αυτό το σύστημα, θα εισάγουμε μια \acl{requirement} αξιοπιστίας:}\acusepage{reliability}
\begin{quote}
...
\begin{figure}
	...
	\caption[Το πλήρες αναπτυξιακό σύστημα]{\g{Το πλήρες δοκιμαστικό σύστημα. Αριστερά, διακρίνεται η μπλε αναπτυξιακή πλακέτα του μικροελεγκτή. Δεξιά βρίσκεται το \e{breadboard}, όπου οι είναι συνδεδεμένοι οι δύο αισθητήρες θερμοκρασίες. Διακρίνεται ακόμα η καλωδίωση από την πλακέτα προς το \e{breadboard}. Οι δύο ενδεικτικές λυχνίες δίνουν μία οπτική ένδειξη του αν το εξάρτημα λαμβάνει ισχύ ή όχι.}}
\end{figure}
...
\g{Το κέντρο του συστήματος επίδειξης είναι ο }\acf{MCU}\g{ που χρησιμοποιείται για την προσομοίωση} του σχεδιασμού και της λειτουργικότητας ενός από τα υποσυστήματα του AcubeSAT (\Cref{sec:obdh}). Ο επιλεγμένος \acl{microcontroller} είναι ο Atmel \texttt{ATSAMV71Q21} που φιλοξενείται στην αναπτυξιακή πλακέτα \foothref{https://www.microchip.com/Developmenttools/ProductDetails/ATSAMV71-XULT}{\texttt{ATSAMV71-XULT}}. Αυτός ο \acl{microcontroller} είναι λειτουργικά πανομοιότυπος με αυτόν που θα χρησιμοποιηθεί στην τροχιά, διαθέτοντας έναν 32-bit πυρήνα ARM Cortex-M7 με μνήμες \SI{2}{\mebi\byte} flash και \SI{384}{\kibi\byte} \acs{SRAM}, και μέγιστη ταχύτητα ρολογιού \SI{300}{\mega\hertz}.
...
Ο \acl{microcontroller} συνδέεται με δύο \textbf{αισθητήρες θερμοκρασίας} οι οποίοι χρησιμοποιούνται για την προσομοίωση εξαρτημάτων του υποσυστήματος που είναι επιρρεπή σε βλάβες. Οι επιλεγμένοι αισθητήρες είναι οι \foothref{https://www.microchip.com/wwwproducts/en/MCP9808}{\texttt{MCP9808}} της Microchip, οι οποίοι προσφέρουν ακριβή και ταχεία ανάγνωση της θερμοκρασίας μέσω ενός διαύλου \ac{I2C}. Η μέγιστη δυνατή περίοδος δειγματοληψίας για τον αισθητήρα είναι \SI{250}{\milli\second}.

\marginnote{%
\textbf{Ψυχρός πλεονασμός} (cold redundancy): Μόνο το ένα εξάρτημα λειτουργεί, ενώ τα άλλα όχι.\acusepage{cold redundancy}

\textbf{Θερμός πλεονασμός} (warm redundancy): Ένα εξάρτημα λειτουργεί πλήρως, ενώ τα άλλα έχουν μειωμένη λειτουργικότητα.\acusepage{warm redundancy}

\textbf{Ενεργός πλεονασμός} (hot redundancy): Δύο ή περισσότερα ταυτόχρονα ενεργά εξαρτήματα λειτουργούν παράλληλα \autocite{SAVOIR-HB-003}.\acusepage{hot redundancy}
}
...
\paragraph{Συνδέσεις}
Η πλακέτα ανάπτυξης και οι αισθητήρες τοποθετήθηκαν και συνδέθηκαν χρησιμοποιώντας ένα breadboard. Τα ολοκληρωμένα κυκλώματα κολλήθηκαν επάνω σε απλές πλακέτες μικρού μεγέθους, που κατασκευάστηκαν με βάση το σχέδιο του Jaroslav Sýkora.\footnote{\url{https://bit.ly/3vZwuh1}}

\begin{figure*}[h]
	\includegraphics{ElectricalSchematic}
	\caption[Απλοποιημένο σχηματικό της εφαρμογής][-4ex]{\g{Απλοποιημένο σχηματικό της εφαρμογής. Οι δύο αισθητήρες είναι συνδεδεμένοι μέσω} \ac{I2C} \g{με τις απαραίτητες αντιστάσεις ανύψωσης στα \SI{3.3}{\volt}. Η τροφοδοσία τους ελέγχεται απευθείας από τις εξόδους του μικροελεγκτή, επιτρέποντας στο χρήστη να τους αποσυνδέσει εντελώς αν χρειαστεί. Οι ακροδέκτες} \texttt{A} \g{των αισθητήρων ρυθμίζονται αυθαίρετα ώστε να επιλέγεται η διεύθυνση} \ac{I2C} \g{της κάθε συ\-σκε\-υής. Χρησιμοποιήσαμε την ίδια διεύθυνση, καθώς οι δύο δίαυλοι} \ac{I2C} \g{είναι πλήρως ανεξάρτητοι. Πυκνωτές αποσύζευξης, κρύσταλλοι και άλλα παθητικά εξαρτήματα δεν φαίνονται, καθώς περιλαμβάνονται ήδη στην έτοιμη αναπτυξιακή πλακέτα.}}
	\label{fig:schematic}
\end{figure*}
...
Επιλέχθηκε το μοντέρνο πρότυπο \texttt{C++17}. Ολόκληρη η εργασία βασίζεται σε ελεύθερο και ανοικτό λογισμικό το οποίο διατίθεται ελεύθερα για λήψη και τροποποίηση σε αποθετήρια \foothref{https://git-scm.com/}{Git}.
...
\begin{table*}[h]
	...
	\begin{tabularx}{\textwidth}{@{}lXp{6cm}@{}}
		...
		\textbf{\texttt{fdir-demo-yamcs}} & Λογισμικό Σταθμού Βάσης: \begin{enumerate}
			\item Διεπαφή\acuse{interface} με το \acs{YAMCS}
			\item Περιγραφή \acs{ECSS} πακέτων, αναγνώσιμη από μηχανή
			\item Διεπαφή\acuse{interface} \acs{UART}--\acs{USB} με τον μικροελεγκτή
...
\begin{table*}[h]
	...
	\begin{tabularx}{\textwidth}{@{}lp{6cm}X@{}}
		...
		& \small
		Προστέθηκαν υλοποιήσεις υπηρεσιών που δεν υπήρχαν, και βελτιώθηκαν συναρτήσεις \acl{interface}ς με τον μικροελεγκτή\newline\small\url{https://gitlab.com/kongr45gpen/ecss-services/-/tree/fdir}
		 \\
...
\begin{table}[h]
	...
	\begin{tabular}{@{}llll@{}}
		...
		\multicolumn{4}{l}{Βελτιστοποίηση ελάχιστου μεγέθους (\texttt{-Os})} \\ \midrule
		Περιοχή μνήμης &        Χρησιμοποιημένη & Συνολικό μέγεθος &  Ποσοστό \\[1ex]
...
\begin{figure}[h]
	...
	\caption[Σήμα σε ένα ελαττωματικό δίκτυο \acs{I2C}]{Σήμα σε ένα ελαττωματικό δίκτυο \acs{I2C},\g{ όπου υπάρχει πολύ μεγάλο χωρητικό φορτίο. Ο χρόνος ανόδου και των δύο σημάτων είναι υπερβολικά μεγάλος, και η επικοινωνία στη συγκεκριμένη συχνότητα δεν είναι δυνατή. Το σήμα δεν προλαβαίνει να φτάσει την τιμή των \SI{3.3}{\volt}. Σε αυτήν την περίπτωση, δεν είναι δυνατή η μεταφορά δεδομένων στον δίαυλο, και το δίκτυο ή το εξάρτημα θεω\-ρεί\-ται πως έχει αποτύχει.}}
...
\g{Ο υπολογιστής του επίγειου τμήματος πρέπει να αναλύει τα λαμβανόμενα πακέτα και να στέλνει εντολές, καθώς και να εμφανίζει πληροφορίες σχετικά με τις μετρήσεις των αισθητήρων, την κατάσταση του \e{\ac{FDIR}}, και την υγεία του συνδεδεμένου συστήματος πτήσης.}
...
\begin{figure*}[h]
	...
	\caption[Η \acl{interface} "PUS database viewer"]{Η \acl{interface} "\acs{PUS} database viewer". \g{Αριστερά βρίσκεται η λίστα ορισμών παρακολούθησης, πάνω δεξιά η λίστα μεταβάσεων, και κάτω δεξιά η λίστα ορισμών γεγονότος-αντίδρασης.}}
	\label{fig:pusviewer}
\end{figure*}

\g{Για να διευκολυνθεί η γρήγορη προβολή της διαδικασίας του} \acs{FDIR}, \g{υλοποιήσαμε μία} online \g{\acl{interface} που δείχνει τα παραπάνω (\Cref{fig:pusviewer}). Η \acl{interface} ενημερώνεται σε πραγματικό χρόνο μέσω του} \acs{YAMCS} \acs{HTTP} \acs{API} και προβάλλει τους ορισμούς αλλά και την κατάσταση του \acs{FDIR}.

Η εφαρμογή γράφτηκε σε HTML και Javascript, εκμεταλλευόμενη WebSockets, και το γραφικό περιβάλλον της βασίζεται στη βιβλιοθήκη Material Design Lite.\footnote[]{\url{https://getmdl.io/}} Βρίσκεται στο αποθετήριο \linebreak[4] \foothref{https://github.com/kongr45gpen/fdir-demo-yamcs/tree/master/ecss-interface}{\texttt{fdir-demo-yamcs}}, μαζί με τα υπόλοιπα κομμάτια του σταθμού βάσης της επίδειξης.


\section{Στήσιμο \acs{FDIR}}

\g{Ο σκοπός της πειραματικής διάταξης είναι να παρατηρηθεί η απόκριση του συστήματος σε τυχόν αποτυχία των δύο "ευπρόσβλητων" αισθητήρων θερμοκρασίας. Για τον σκοπό αυτό, θα προσπαθήσουμε να προσομοιώσουμε κάθε τρόπο αποτυχίας κάθε αισθητήρα, και να σχεδιάσουμε μια υλοποίηση} \ac{FDIR} που να προβλέπει όλες αυτές τις αστοχίες.
...
\begin{table*}[h]
	...
	\begin{tabular}{@{}lL{4cm}L{2cm}L{1cm}L{4cm}L{2cm}L{4cm}L{1.5cm}L{3cm}@{}}
		\toprule
		\multicolumn{1}{l}{ID}                            & Τρόπος Αποτυχίας\acusepage{failure mode}                     & Αίτιο Αποτυχίας     & Φάση αποστολής     & Συνέπειες αποτυχίας: Τοπικές                                    & Συνέπειες αποτυχίας: Τελικές & Εντοπισμός Αποτυχίας/Παρατηρήσιμα Συμπτώματα                                               & Επίπεδο σο\-βα\-ρό\-τη\-τας & Προβλέψεις αντιστάθμισης             \\ \midrule
		\multicolumn{9}{l}{Αισθητήρας θερμοκρασίας MCP9808 \#1}                                                                                                                                                                                                                                                                                                                                                               \\ \midrule
		\textbf{\texttt{F-010}}                                      & Προσωρινή απώλεια λειτουργικότητας       & Τυχαίο, Ακτινοβολία & Όλες & Δε λαμβάνονται μετρήσεις από τον αισθητήρα               & Καμία                         & Καμία επικοινωνία μέσω \acs{I2C}                                                            & 4              & Πλεονασμός με 2 συνολικά αισθητήρες   \\
		\textbf{\texttt{F-020}}                                      & Μόνιμη απώλεια λειτουργικότητας       & Τυχαίο, Ακτινοβολία & Όλες & Δε λαμβάνονται μετρήσεις από τον αισθητήρα               & Καμία                         & Καμία επικοινωνία μέσω \acs{I2C}                                                            & 4              & Πλεονασμός με 2 συνολικά αισθητήρες   \\
		\textbf{\texttt{F-030}}                                      & \g{Βραχυκύκλωμα ακροδεκτών ισχύος} & Τυχαίο, Ακτινοβολία & Όλες & Δε λαμβάνονται μετρήσεις από τον αισθητήρα               & Καμία                         & Καμία επικοινωνία μέσω \acs{I2C}                                                            & 4              & Αντίσταση περιορισμού ρεύματος           \\
		...
		\textbf{\texttt{F-050}}                                      & Μόνιμη αλλαγή τιμής            & Τυχαίο, Ακτινοβολία & Όλες & Λανθασμένες θερμοκρασιακές μετρήσεις & Καμία                         & Μεγάλη διαφορά θερμοκρασίας μεταξύ 2 αισθητήρων  & 4              & Πλεονασμός με 2 συνολικά αισθητήρες   \\
		...
		\multicolumn{9}{l}{Αισθητήρας θερμοκρασίας MCP9808 \#2}                        \\ \midrule
			\textbf{\texttt{F-070}}                                      & Προσωρινή απώλεια λειτουργικότητας       & Τυχαίο, Ακτινοβολία & Όλες & Δε λαμβάνονται μετρήσεις από τον αισθητήρα               & Καμία                         & Καμία επικοινωνία μέσω \acs{I2C}                                                            & 4              & Πλεονασμός με 2 συνολικά αισθητήρες   \\
	\textbf{\texttt{F-080}}                                      & Μόνιμη απώλεια λειτουργικότητας       & Τυχαίο, Ακτινοβολία & Όλες & Δε λαμβάνονται μετρήσεις από τον αισθητήρα               & Καμία                         & Καμία επικοινωνία μέσω \acs{I2C}                                                            & 4              & Πλεονασμός με 2 συνολικά αισθητήρες   \\
	\textbf{\texttt{F-090}}                                      & \g{Βραχυκύκλωμα ακροδεκτών ισχύος} & Τυχαίο, Ακτινοβολία & Όλες & Δε λαμβάνονται μετρήσεις από τον αισθητήρα               & Καμία                         & Καμία επικοινωνία μέσω \acs{I2C}                                                            & 4              & Αντίσταση περιορισμού ρεύματος           \\
	...
	\textbf{\texttt{F-120}}                                      & Κολλημένος ακροδέκτης εξόδου \acs{I2C}         & Τυχαίο, Ακτινοβολία & Όλες & Αδυναμία επικοινωνίας και με τους 2 αισθητήρες & Καμία                         & Καμία επικοινωνία μέσω \acs{I2C} για όλους τους αισθητήρες & 4              & Αισθητήρες συνδεδεμένοι σε διαφορετικούς διαύλους \acs{I2C} \\ \midrule
		...
		\textbf{\texttt{F-130}}                                      & Υπερθέρμανση       & \g{Βραχυκύκλωμα, περιβάλλον} & Όλες & Αποτυχία ευάλωτων εξαρτημάτων & Απώλεια λειτουργικότητας υποσυστήματος & Μετρημένη θερμοκρασία εκτός του αναμενόμενου εύρους  & 3              & \g{Θερμική ανάλυση με περιθώριο ασφαλείας, προστασία υπερέντασης}  \\
		\bottomrule
	\end{tabular}
	\end{adjustbox}
\end{table*}
...
\begin{figure*}[ht]
	...
	\caption[Επισκόπηση της διαδικασίας FDIR του αισθητήρα θερμοκρασίας][-3cm]{Σύνοψη της διαδικασίας \ac{FDIR}\g{ του αισθητήρα θερμοκρασίας. Για κάθε διεργασία που εκτελείται και για κάθε σφάλμα που εντοπίζεται, παράγεται και η αντίστοιχη τηλεμετρία.}}
	\label{fig:fdirtemp}
\end{figure*}
...
\g{Η προσέγγιση ακολουθά τα παρακάτω βήματα, τα οποία εκτελούνται διαρκώς στο υπόβαθρο:}
...
\begin{tabular}{@{}rl@{}}
	\toprule
	Κατηγορία Αποτυχίας & Επίπεδο \\ \midrule
	Καταστροφική/Επιβλαβής & 1 \\
	Κρίσιμη & 2 \\
	Μεγάλη & 3 \\
	Μικρή/Αμελητέα & 4 \\ \bottomrule
\end{tabular}
\caption{Ανάθεση επιπέδων σοβαρότητας του \Cref{tab:fmea}}
\end{margintable}
...
Για τους σκοπούς αυτής της επίδειξης, θα θεωρήσουμε ότι όλα τα στοιχεία \ac{FMEA} μπορούν να οδηγήσουν σε \emph{επίφοβες αποτυχίες} (feared events), δηλαδή ότι το \ac{FDIR}\g{ θα καλύπτει όλες τις αναγνωρισμένες πιθανές αποτυχίες.}
...
\begin{itemize}
	...
	\g{Αυτές παρατίθενται εδώ σε όρους παραμέτρων} \ac{PUS} \g{που μπο\-ρούν εύκολα να διαβαστούν και να συγκριθούν από το λογισμικό. Αυτός ο κατάλογος συνδέεται στη συνέχεια με τους αντίστοιχους ορισμούς της υπηρεσίας} \emph{\texttt{ST[12]} on-board monitoring}, \g{που παρατίθενται στον \Cref{tab:demo_monitoring}.}
...
\begin{table*}
	\centering
	\caption{Πίνακας \acs{HSIA}}
	\label{tab:hsia}
	\begin{tabular}{@{}lL{4cm}L{4cm}L{1cm}L{1.1cm}L{3.5cm}@{}}
		\toprule
		ID & Τρόπος Αποτυχίας\acusepage{failure mode} & Παρατηρούμενες Παράμετροι & ST[12] ID & ST[05] ID & Ενέργεια αποκατάστασης \\ \midrule
		...
		\textbf{\texttt{F-030}} & \g{Βραχυκύκλωμα ακροδεκτών ισχύος} & \(\texttt{T1\_Status} = \texttt{TIMEOUT}\) \newline 5 φορές & 2 & 2 & Αγνόηση αισθητήρα 1 \\[5ex]
...
Πέρα από τις εξόδους των αισθητήρων, έχουμε συμπεριλάβει τη \textbf{διαφορά} (\(\Delta\)) μεταξύ των δύο θερμοκρασιών, καθώς το πρότυπο \acs{PUS} δεν παρέχει τρόπους για την εκτέλεση αριθμητικών υπολογισμών. Επιπλέον, περιλαμβάνεται η κατάσταση λειτουργίας του κάθε αισθητήρα, η οποία είναι μια απαριθμημένη (enumerated)\acusepage{enumeration} τιμή.\footnote{Η τιμή μπορεί να είναι μία από τις \texttt{NOMINAL} (\g{ο αισθητήρας λειτουργεί κανονικά}), \texttt{TIMEOUT} (\g{έχει εντοπιστεί κάποιο σφάλμα}) ή \texttt{DISABLED} (\g{ο αισθητήρας είναι ρητά απενεργοποιημένος}).}

Αυτές οι παράμετροι τηλεμετρώνται στον σταθμό βάσης και εμφανίζονται στο χρήστη περιοδικά, μέσω της υπηρεσίας \emph{\texttt{ST[03]} housekeeping} \ac{PUS} και των ραδιοφάρων που αυτή εκπέμπει. Ωστόσο, όταν το CubeSat βρίσκεται στο διάστημα, ο σταθμός βάσης δεν θα έχει συνεχή πρόσβαση σε αυτά τα δεδομένα, καθώς ο δορυφόρος δεν θα είναι ορατός από τους επίγειους σταθμούς καθ' όλη τη διάρκεια της τροχιάς του.
...
\g{Οι \emph{συνθήκες εγκυρότητας ελέγχου} είναι σημαντικό να α\-να\-φερ\-θούν σε αυτήν την περίπτωση, καθώς χρησιμοποιούν τις τρεις παραμέτρους \emph{Κατάστασης} του \Cref{tab:demo_params} για να αποτρέψουν την εκτέλεση ελέγχων σε απενεργοποιημένα περιφερειακά.} \g{Ως εκ τού\-του, οι αισθητήρες που δεν παρέχουν τιμές λόγω προβλημάτων υλικού, ενεργειών} \ac{FDIR} ή κάποιας ρητής τηλεεντολής από το Σταθμό Βάσης, δεν θα μπορούν να ενεργοποιήσουν ενέργειες \ac{FDIR}.
...
\begin{itemize}
	\item \ac{PUS} γεγονότα (υπηρεσία \texttt{ST[05]}), τα οποία εκπέμπονται αυτόματα όταν ένας \acl{monitoring definition} ξεπερνά τα όριά του
	\item \ac{PUS} ορισμοί γεγονότων-αντιδράσεων (υπηρεσία \texttt{ST[19]}), \g{οι ο\-ποί\-οι συνδέουν κάθε εμφάνιση ενός γεγονότος με μία αποθηκευμένη τηλεεντολή που εκτελείται αμέσως και αναπαριστά τις διαδικασίες ανάκτησης του} \acs{FDIR}.
\end{itemize}

\g{Όλοι αυτοί οι ορισμοί μπορούν εύκολα να τροποποιηθούν από τους \aclp{operator} με τη χρήση μεμονωμένων τηλεεντολών, οι οποίες επιδρούν επάνω στην βάση δεδομένων του διαστημικού εξοπλισμού.}
...
\begin{table}[h]
	...
	\begin{tabularx}{\textwidth}{@{}L{1.8cm}L{2cm}X@{}}
		\toprule
		ID γεγονότος & \acl{monitoring definition} & Αντίδραση \\ \midrule
...
\acusepage{verification}
\acusepage{validation}

\g{Στην ενότητα αυτήν παρουσιάζονται οι ενέργειες επαλήθευσης και επικύρωσης του συστήματος \e{\acs{FDIR}}, ώστε να διαπιστώσουμε αν καλύπτονται οι δεδομένες προδιαγραφές, και αν το σύστημα μπορεί να διορθώσει όλες τις βλάβες, όπως επιθυμούμε.}
...
\begin{figure}[h]
	...
	\caption{Εξέλιξη μιας παραμέτρου θερμοκρασίας στον χρόνο, όπως φαίνεται στο \acs{YAMCS}}
...
\marginnote{Γενικά είδη κατάστασης \autocite{ECSS-E-ST-70-41C}:
	...
	\unchecked: Ο έλεγχος είναι απενεργοποιημένος.

	\ok: Η μεταβλητή βρίσκεται εντός ορίων.

	\invalid: Η συνθήκη εγκυρότητας του ελέγχου\acusepage{check validity condition} είναι ψευδής. Ο έλεγχος δεν πραγματοποιείται.
}

Ιδιαίτερο ενδιαφέρον έχει να παρατηρήσουμε την κατάσταση του συστήματος \acs{FDIR} κατά την εκκίνηση. Η πρώτη πληροφορία που λαμβάνουμε φαίνεται στο \Cref{fig:pus_boot}. Η εικόνα αυτή δείχνει τις \textbf{μεταβάσεις (transitions)} της υπηρεσίας \emph{\texttt{ST[12]} on-board monitoring}, όπως φαίνονται στην \acl{interface} που αναπτύξαμε (\Cref{sec:pusinterface}). Πρακτικά, αυτή η προβολή δείχνει το \textbf{αποτέλεσμα} του κάθε ελέγχου, και αν η τιμή είναι εντός ορίων, εκτός ορίων, ή αν ο έλεγχος είναι απενεργοποιημένος.
...
Ο διαφορετικός χρόνος μετάβασης του κάθε ορισμού οφείλεται στον διαφορετικό \textbf{αριθμό επαναλήψεων}. Για να καταχωρηθεί η μετάβαση, πρέπει η μεταβλητή να έχει μετρηθεί όσες φορές δηλώνει αυτός ο αριθμός, που ορίζεται από τους \aclp{operator}.
...
\begin{figure}[h]
	...
	\caption[Λίστα ορισμών παρακολούθησης στην εκκίνηση, χωρίς καμία αποτυχία]{\g{Λίστα ορισμών παρακολούθησης στην εκκίνηση, χωρίς καμία αποτυχία. Τα δεδομένα αυτά λαμβάνονται ως τηλεμετρία από τον μικροελεγκτή και αντιστοιχούν ακριβώς στις τιμές του \Cref{tab:demo_monitoring}.}}
	\label{fig:pus_obmd}
\end{figure}
...
\g{Ακόμα, κατά την εκκίνηση, δημιουργείται ένα \textbf{\acl{event}} της υπηρεσίας} \emph{\texttt{ST[05]} event reporting} \g{που ανακοινώνει την εκκίνηση του μικροελεγκτή} (\Cref{fig:yamcsmcustart}).
...
\begin{table*}
	...
	\begin{tabularx}{\textwidth}{@{}lL{4cm}L{3.5cm}X@{}}
		...
		\textbf{\texttt{F-030}} & \g{Βραχυκύκλωμα ακροδεκτών ισχύος} & Αγνόηση αισθητήρα 1 & \emph{Ίδιο με \texttt{F-020}}  \\
...
\begin{figure}[h]
	...
	\caption{\g{Θερμοκρασιακές παράμετροι }\acs{YAMCS}\g{ σε κανονική λειτουργία}}
...
\begin{enumerate}
	\item Με το που αποσυνδέεται ο αισθητήρας, οι ορισμοί 4, 6, 7, 9 και 10 (\cref{tab:demo_monitoring}) αποκτούν κατάσταση \invalid. Αυτό συμβαίνει καθώς για αυτούς τους ορισμούς υπάρχει \textbf{\acl{check validity condition}}. Αν ο αισθητήρας 1 είναι απενεργοποιημένος,\footnote{είτε λόγω προβλήματος, είτε λόγω εντολής} δεν έχει κανένα νόημα η λήψη των τιμών του για εύρεση λαθών.
	...
	\item Μετά από δύο μετρήσεις και χρόνο \( 2 \cdot 500 = \SI{1000}{\milli\second} \), ο \acl{monitoring definition} 0 επιβεβαιώνει πως η παράμετρος \emph{Κατάσταση Θερμοκρασία 1} έχει ανεπιθύμητη τιμή. \g{Ως αποτέλεσμα, ο \acl{monitoring definition} μεταβαίνει σε κατάσταση \e{\unexpected}, και πυροδοτεί όλη τη διαδικασία αναφοράς και διόρθωσης της βλάβης. Η αποτυχία του αισθητήρα έχει πλέον εντοπιστεί, και το σύστημα \e{\acs{FDIR}} έχει αρχίσει να δρα.}
...
\begin{figure}
	\centering
	\caption[Πλήρης λίστα των ορισμών παρακολούθησης κατά την αποτυχία \texttt{F-010}]{Πλήρης λίστα των ορισμών παρακολούθησης κατά την αποτυχία \texttt{F-010}, όπως φαίνονται στην \acl{interface}
...
Μετά από τον εντοπισμό της αποτυχίας, δημιουργείται το αντίστοιχο \textbf{\acl{event}} και αποστέλλεται στους \aclp{operator} (\Cref{fig:yamcsf010event}).

\begin{figure*}
	\centering
	\includegraphics{media/screenshots/yamcs_f010_event}
	\caption[][-10pt]{Το \acl{event} προσωρινής αποτυχίας του αισθητήρα όπως φαίνεται στο \acs{YAMCS}}
	\label{fig:yamcsf010event}
\end{figure*}

\g{Με την αποστολή του γεγονότος, πυροδοτείται ο μηχανισμός γε\-γο\-νό\-τος-α\-ντί\-δρα\-σης.\acusepage{event-action} Η αντίδραση που συνδέεται με την προσωρινή αποτυχία του αισθητήρα είναι η κλήση της συνάρτησης} \texttt{restart\_sensor}\footnote{Υπηρεσία \emph{\texttt{ST[08]} function management}}\g{ με όρισμα \texttt{1}, που σηματοδοτεί την επανεκκίνηση του 1\textsuperscript{ου} αισθητήρα. Στους ανθρώπινους παρατηρητές, η ενδεικτική λυχνία \textbf{αναβοσβήνει}, καθώς το σύστημα επανεκκίνησε την τροφοδοσία του αισθητήρα. Αυτή ήταν η πρώτη προσπάθεια για επιδιόρθωση του προβλήματος.}
...
...
	\end{cminted}
	\caption[Διαγνωστική έξοδος του μικροελεγκτή κατά την αποτυχία \texttt{F-010}]{Διαγνωστική έξοδος του μικροελεγκτή κατά την αποτυχία \texttt{F-010}. Μόλις το καλώδιο αποσυνδεθεί, ο \acl{microcontroller} εντοπίζει το σφάλμα στον δίαυλο \acs{I2C}, και η τιμή της αναγνώσιμης θερμοκρασίας γίνεται μηδενική. Η κατάσταση των ορισμών παρακούθησης αλλάζει στον αντίστοιχο χτύπο ρολογιού. Ταυτόχρονα, δημιουργούνται οι τηλεμετρίες ραδιοφάρου (\texttt{[3,25]}) και αναφοράς των μεταβάσεων (\texttt{ST[12,12]}). Τα διαγνωστικά αυτά δεδομένα παράγονται σε μορφή κειμένου από το μικροελεγκτή και δεν θα είναι διαθέσιμα σε τροχιά.}
\end{figure}
...
\g{Στη δοκιμή αυτή το σύστημα αναγνωρίζει κανονικά την αποτυχία του αισθητήρα, και, όπως φαίνεται στον \Cref{tab:f020tr}, προσπαθεί να την διορθώσει δύο φορές:}
\begin{enumerate}
	...
	\item (\( t = \SI{2.5}{\second} \)) Ο \acl{monitoring definition} \texttt{2} έχει μετρήση την κατάσταση του αισθητήρα 5 φορές (repetition number), \g{χωρίς καμία επιτυχία. Το σύστημα θεωρεί πως η βλάβη δεν μπορεί να διορθωθεί, και \textbf{απενεργοποιεί} πλήρως την τροφοδοσία του αισθητήρα.}
...
Σε αυτό το σημείο, ο ανενεργός αισθητήρας μπορεί να επαναφερθεί μόνο με κάποια τηλεεντολή, ή με επανεκκίνηση του συστήματος. Μέσα από τη \acl{interface} του \acs{YAMCS}, ο χρήστης μπορεί να στείλει την εντολή \mintinline{cpp}{/fdirdemo/Set_Temp1_Status(Temperature_Status: "Nominal")} και ο αισθητήρας να ενεργοποιηθεί ξανά.\footnote[][2ex]{Εσωτερικά, αυτή η εντολή καλεί την υπηρεσία \emph{\texttt{ST[20]} parameter management}, και θέτει την παράμετρο \emph{Κατάσταση Θερμοκρασία 1} σε τιμή \texttt{NOMINAL}} Αν ο αισθητήρας συνεχίσει να είναι αποσυνδεδεμένος, παρατηρούμε πως η διαδικασία \acs{FDIR} επαναλαμβάνεται όπως αναμένεται, και απενεργοποιεί ξανά την τροφοδοσία.
...
\begin{figure*}[h]
	...
	\caption[Προβολή της παραμέτρου θερμοκρασίας στη διάρκεια της αποτυχίας \texttt{F-040}]{Προβολή της παραμέτρου θερμοκρασίας στη διάρκεια της αποτυχίας \texttt{F-040}. Φαίνεται η υπερβολικά μεγάλη τιμή που εισήγαγε το \g{λογισμικό.}}
...
Τα βήματα διόρθωσης και απομόνωσης είναι αντίστοιχα με αυτά της αποτυχίας \texttt{F-020}, και απαιτείται ξανά επέμβαση από τους \aclp{operator} για οποιαδήποτε άλλη κίνηση.
...
\subparagraph{Οπτική ένδειξη (μόνιμη αποτυχία)} \g{Και οι δύο ενδεικτικές λυχνίες αναβοσβήνουν ταυτόχρονα μια φορά, παραμένουν ανοιχτές, και μετά σβήνουν μόνιμα.}
...
\g{Αυτή η αποτυχία προσομοιώνεται με σύνδεση επιπλέον καλωδίου. Σε τέτοιες περιπτώσεις πρέπει να δίνεται προσοχή ώστε να μη γίνονται συνδέσεις (π.χ. βραχυκυκλώματα) που θα βλάψουν το δοκιμαστικό σύστημα, ειδικά αν δεν υπάρχουν κατάλληλα κυκλώματα προστασίας.}
...
\g{Οι παραπάνω δοκιμές επαναλήφθηκαν και για τον 2\textsuperscript{ο} αισθητήρα. Τα αποτελέσματα των δοκιμών είναι ίδια με αυτά του 1\textsuperscript{ου} αισθητήρα, καθώς τα εξαρτήματα έχουν ίδια συμπεριφορά και σχεδιασμό \e{\acs{FDIR}.}}
...
\begin{table*}[h]
	...
	\begin{tabularx}{\linewidth}{@{}S[table-format=4.0]c@{\hskip 3em}rcl@{\hskip 3em}X@{}}
		...
		\multicolumn{6}{l}{\cellcolor{MaterialYellow300}\textcolor{black}{Αυτόνομη επανεκκίνηση μικροελεγκτή}}\\
		\bottomrule
	\end{tabularx}
	\vspace{10pt}
\end{table*}

Εδώ ενεργοποιείται ο \acl{monitoring definition} που συνδέεται με τον αισθητήρα που έφτασε στους \SI{50}{\celsius}. Μόλις το σύστημα περάσει αρκετή ώρα σε αυτήν τη θερμοκρασία, γίνεται άμεσα μία επανεκκίνηση του μικροελεγκτή. Η επανεκκίνηση αυτή θα συνεχίσει να γίνεται, μέχρι η θερμοκρασία να επανέλθει.

Η αποτυχία αυτή ουσιαστικά ανήκει στο επίπεδο υποσυστήματος και όχι υλικού που μελετούσαμε προηγουμένως. Σημειώνουμε επίσης πως, λόγω του μεγάλου χρονικού διαστήματος μεταξύ των επανεκκινήσεων, οι \aclp{operator} έχουν αρκετό χρόνο στη διάθεσή τους ώστε να απενεργοποιήσουν το \acs{FDIR} ή να λάβουν και να επεξεργαστούν την τηλεμετρία.

\begin{figure*}
	\includegraphics{screenshots/yamcs_f130_parameters}
	\caption[Οι μετρήσεις θερμοκρασίας στις οποίες έχουν προστεθεί εικονικές τιμές]{Οι μετρήσεις θερμοκρασίας στις οποίες έχουν προστεθεί εικονικές τιμές, μέσα από το \acs{YAMCS}. Η θερμοκρασία φτάνει μέχρι τους \SI{90}{\celsius}, μέχρι που ο \acl{microcontroller} κάνει επανεκκίνηση, και η θερμοκρασία επανέρχεται σε κανονικό επίπεδο}
\end{figure*}
...
\begin{table*}[h]
	...
	\begin{tabularx}{\textwidth}{@{}lXlL{4cm}@{}}
		\toprule
		\# & Προδιαγραφή\acuse{requirement} & Υπηρεσία & Λεπτομέρειες \\ \midrule
		\texttt{RC-010} & Οι αναφορές FDIR\g{ πρέπει να περιέχουν όλες τις πληροφορίες για την ανάλυση αποτυχιών (π.χ. ώρα εμφάνισης, παράμετροι εκτός ορίων, πραγματοποιημένες μεταγωγές).} & ST[12] on-board monitoring & Μέσω περιοδικών \emph{αναφορών μεταγωγής} \\
...
\begin{figure}[h]
	...
	\caption[Λίστα τηλεεντολών στο περιβάλλον του \acs{YAMCS}]{Λίστα τηλεεντολών στο περιβάλλον του \acs{YAMCS}. \g{Αυτές οι εντολές μπορούν να εκκινήσουν διαδικασίες στον δορυφόρο, να ενεργοποιήσουν/απενεργοποιήσουν αισθητήρες, ή να αλλάξουν τις ρυθμίσεις των εξαρτημάτων του δορυφόρου. Η λίστα αυτών των εντολών παρέχεται στο }\acs{YAMCS} μέσω των αρχείων \ac{XTCE} (\Cref{app:xtce}).}
	\label{fig:yamcs_commands}
\end{figure}

\paragraph{\textbf{\texttt{RC-010} Παρατηρησιμότητα \acs{FDIR}}}~

Ο βαθμός παρατηρησιμότητας που απαιτείται, σε πραγματικό και μη χρόνο, εξασφαλίζεται μέσω της \acl{interface}ς που παρουσιάστηκε στην \Cref{sec:pusinterface}. Οι έτοιμες δομές τηλεμετρίας που υλοποιούνται από το πρότυπο \acs{PUS} \autocite{ECSS-E-ST-70-41C} είναι:
\begin{compactitem}
	\item \texttt{TM[3,25]}: Περιοδική αναφορά τιμών παραμέτρων (\acl{beacon})
...
\g{Με το παραπάνω σύνολο τηλεμετρίας, που κατεβαίνει είτε αυτόνομα είτε μετά από εντολή, οι \aclp{operator} έχουν τη δυνατότητα να μελετήσουν την κατάσταση του συστήματος και του} \acs{FDIR} με λεπτομέρεια. Όλα τα αποτελέσματα στην \Cref{sec:simul} εξάχθηκαν χρησιμοποιώντας τις παραπάνω δομές τηλεμετρίας.
...
\begin{itemize}
	...
	\begin{figure}[h]
		...
		\caption[Προβολή της οθόνης εκτέλεσης εντολής του \acs{YAMCS}]{Προβολή της οθόνης εκτέλεσης εντολής του \acs{YAMCS}. Ο χρήστης καλείται να εισάγει το ένα όρισμα της εντολής \texttt{TC[12,1]}, που είναι ο \acl{monitoring definition} που επιθυμεί να απενεργοποιήσει.}
	...
	Πέρα από την απενεργοποίηση ολόκληρου του \acs{FDIR} για ένα εξάρτημα, δίνεται η δυνατότητα απενεργοποίησης μόνο του ``IR''\footnote{\textcolor{MaterialGrey400}{Detection, }Isolation \& Recovery} κομματιού του. Αυτό σημαίνει πως ενώ γίνεται εντοπισμός των αποτυχιών, δεν γίνεται \textbf{καμία προσπάθεια για απομόνωση ή επιδιόρθωσή τους}. \g{Με αυτόν τον τρόπο μπορούμε να απενεργοποιήσουμε το} \acs{FDIR}\g{, αλλά να διατηρήσουμε την παρατηρησιμότητα των παραμέτρων και των ορίων.}

	Πιο τεχνικά, η εντολή αυτή απενεργοποιεί τους ορισμούς γε\-γο\-νό\-τος-α\-ντί\-δρα\-σης για συγκεκριμένα γεγονότα. Η συμπεριφορά μιας τυπικής αποτυχίας αφού έχει εκτελεστεί αυτή η εντολή φαίνεται στον \Cref{tab:eaofftr}.
...
\begin{itemize}
	...
	Μέσω της τηλεεντολής \texttt{TC[12,5]} \g{μπορούμε να παρέχουμε στο δορυφόρο όλα τα δεδομένα που χρειάζονται για να προστεθεί ένας \acl{monitoring definition}, για οποιονδήποτε τύπο παραμέτρου, ελέγχου τιμής και ελέγχου εγκυρότητας.}
	...
	\g{Παρ' όλα αυτά, η μεταβολή μέσω διαγραφής και προσθήκης δεν συνιστάται από το \e{\acs{SAVOIR} \autocite{SAVOIR-HB-003}}, καθώς διατρέχει το ρίσκο να μην εκτελεστεί η μία από τις δύο εντολές, και το σύστημα να βρεθεί σε μία ανεπιθύμητη κατάσταση.}

\end{itemize}

\paragraph{\textbf{\texttt{RC-040} Προσθήκη/διαγραφή αντιδράσεων}}~

\g{Αντίστοιχα με τους ορισμούς παρακολούθησης, οι \aclp{operator} μπορούν να συνδέσουν τις κατάλληλες αντιδράσεις με αυτούς τους ορισμούς,} εκμεταλλευόμενοι τις συναρτήσεις της υπηρεσίας \emph{\texttt{ST[19]} eventaction}. Σε όλες τις παρακάτω συναρτήσεις, η πρόσβαση στους ορισμούς γίνεται με βάση το αναγνωριστικό της εφαρμογής (\e{application process ID}) και του γεγονότος (\e{event ID}).

\begin{itemize}
	\item \texttt{TC[19,1]}: \emph{add event-action definitions}

	\g{Σημειώνουμε πως το κομμάτι της \emph{αντίδρασης} ορίζεται από τον χρήστη ως ένα \textbf{πακέτο τηλεεντολής}. Έτσι, δίνοντας μία εμφωλευμένη αυθαίρετη τηλεεντολή, οι \aclp{operator} μπορούν να καθοδηγήσουν τον δορυφόρο ώστε να εκτελέσει πρακτικά οποιαδήποτε ενέργεια μετά από μία αποτυχία.}
...
\begin{fullwidth}
Η διπλωματική εργασία παρουσίασε την αρχιτεκτονική και την υλοποίηση μιας μεθόδου ανίχνευσης, απομόνωσης και αντιμετώπισης βλαβών σε διαστημικά συστήματα χαμηλού κόστους. \g{Στο \Cref{cap:acubesat}, έγινε μία σύντομη παρουσίαση της αποστολής \e{AcubeSAT} και των λεπτομερειών της που συνδέονται άμεσα με την αξιοπιστία του δορυφόρου. Στο \Cref{cap:savoir} έγινε μία παρουσίαση των προτύπων} \texttt{ECSS-E-ST-70-41C} και \texttt{SAVOIR-HB-003}, τα οποία προτείνουν μεθόδους για ανάπτυξη ενός δομημένου διαχειριστικού πλαισίου και μίας παραμετροποιήσιμης αρχιτεκτονικής διόρθωσης σφαλμάτων. Παρουσιάστηκαν ακόμα τα 7 βήματα της διαδικασία υλοποίησης του \acs{FDIR}, ξεκινώντας από τη συγγραφή των προδιαγραφών, συνεχίζοντας με τον σχεδιασμό, και καταλήγοντας στην υλοποίηση και τις δοκιμές αξιοπιστίας. Ακόμα, παρουσιάστηκε η ιδέα του \acf{FMEA} και η σύνδεσή του με το λογισμικό. Στο \Cref{cap:acufdir}, οι προηγούμενες πληροφορίες έγιναν πιο συγκεκριμένες, αφού εφαρμόστηκαν στα σχέδια του νανοδορυφόρου AcubeSAT. Πιο συγκεκριμένα, πρώτα τέθηκαν οι απαιτήσεις του συστήματος \acs{FDIR} και πραγματοποιήθηκε θεωρητική ανάλυση διαφορετικών αρχιτεκτονικών με σκοπό την αύξηση αξιοπιστίας. Τέλος, παρουσιάστηκαν όλες οι μέθοδοι εντοπισμού, πρόληψης και επιδιόρθωσης βλαβών που είναι διαθέσιμες στον νανοδορυφόρο, και προετοιμάστηκαν τα διαγράμματα ροής που δείχνουν τις συγκεκριμένες ενέργειες του \acs{FDIR} σε κάθε λειτουργία συστήματος.

Στο \Cref{cap:practical} εφαρμόστηκαν τα 7 βήματα της διαδικασίας \acs{FDIR} σε μία μικρογραφία ενός \g{δορυφορικού συστήματος. Το φυσικό σύστημα που περιείχε έναν μικροελεγκτή και 2 αισθητήρες θερμοκρασίας εμπλουτίστηκε με υλοποιήσεις των προαναφερθέντων προτύπων, και με μία πλατφόρμα εξομοίωσης του σταθμού βάσης. Ο σχεδιασμός του} \acs{FDIR} βασίστηκε σε ένα πλήρες \acs{FMEA} του συστήματος, βάσει του οποίου εξήχθησαν οι παρακολουθούμενες παράμετροι, τα κατώφλια επικινδυνότητάς τους, και οι διορθωτικές ενέργειες. Η διαδικασία αυτή πραγματοποιήθηκε για κάθε πιθανή βλάβη του αισθητήριου συστήματος. Στη συνέχεια, κάθε μία από τις βλάβες προσομοιώθηκε σε υλικό ή λογισμικό, και αποδείχθηκε πως το σύστημα μπορούσε να ανακάμψει σε κάθε περίπτωση. Τέλος, έγινε επίδειξη της δυνατότητας παραμετροποίησης του \acs{FDIR} σε τροχιά χωρίς τροποποίηση του λογισμικού.

Το αποτέλεσμα της παραπάνω μελέτης και των δοκιμών δείχνει πως είναι δυνατή η εφαρμογή της μεθόδου \acs{SAVOIR} για την επιδιόρθωση βλαβών σε έναν νανοδορυφόρο. Η λογική που προτάθηκε μπορεί να υποστηριχθεί από έναν μικροελεγκτή χαμηλών πόρων, και το λογισμικό μπορεί να χρησιμοποιηθεί αυτούσιο για οποιοδήποτε ευάλωτο σύστημα, κάτι που γίνεται δυνατό χάρη στην κλιμακούμενη αρχιτεκτονική που προτείνεται. Η χρήση μιας τέτοιας δομημένης προσέγγισης κρίνεται πως μπορεί να αυξήσει σε μεγάλο βαθμό τις πιθανότητες επιβίωσης ενός CubeSat σε τροχιά, αλλά και να μειώσει τον χρόνο ανάπτυξης μιας αποστολής, καθώς μπορούν να χρησιμοποιηθούν έτοιμα πρότυπα και λο\-γι\-σμι\-κό. Οι βιβλιοθήκες που χρησιμοποιήθηκαν, αν και είναι ανοιχτού κώδικα και διαθέσιμες προς χρήση, μπορούν ελεύθερα να αντικατασταθούν με αντίστοιχες που προσφέρουν την ίδια λειτουργικότητα.

\g{Στο σημείο αυτό πρέπει να τονιστεί η σημασία της επαλήθευσης και των δοκιμών της υλοποίησης που εφαρμόζεται. Όσο περισσότερο οι συνθήκες των δοκιμών αναπαριστούν τις πραγματικές συνθήκες, τόσο βελτιώνεται η εμπιστοσύνη στους υλοποιημένους μηχανισμούς. Στις δικές μας δοκιμές διαπιστώσαμε έναν σημαντικό αριθμό ελλείψεων, οριακών περιπτώσεων και συνθηκών συναγωνισμού (\e{race conditions}) που δεν ήταν προφανείς κατά τον σχεδιασμό και τις απλές δοκιμές, αλλά εμφανίστηκαν άμεσα στις δοκιμές κάθε αποτυχίας ξεχωριστά.}

Παρά τις δυνατότητες που δίνονται από ένα τέτοιο σύστημα, σημειώσαμε τις εξής λεπτομέρειες υλοποίησης που χρήζουν προσοχή:
\begin{itemize}
	\item Μία βιαστική υλοποίηση του \acs{FDIR} μπορεί να οδηγήσει σε μεγάλη αύξηση της πολυπλοκότητας, και δυσκολία διαχείρισης όλων των ορισμών αξιοπιστίας. Η πολυπλοκότητα αυξάνει την πιθανότητα ανθρώπινου λάθους, σφαλμάτων που δεν εντοπίζονται, αλλά και κακής λειτουργίας του συστήματος όταν αποστέλλονται πολλές εντολές που μπορεί να μην εκτελεστούν. Σε μη κρίσιμα συστήματα, προτείνεται το πλήθος των ορισμών να περιοριστεί σε έναν διαχειρίσιμο αριθμό. \g{Ενδεικτικά στο παράδειγμά μας, θα μπορούσαν να αφαιρεθούν οι παρακολουθήσεις της διαφοράς \(Δ\) των θερμοκρασιών, αντικαθιστώμενες από έλεγχο ώστε και οι 2 αισθητήρες να είναι εκτός ορίων για την επανεκκίνηση του υποσυστήματος.}
	\item Οι διαφορετικοί τύποι μεταβλητών των παραμέτρων (\mintinline{cpp}{uint16_t}, \mintinline{cpp}{uint32_t}, \mintinline{cpp}{float} κ.ά.) δημιουργούν δυσκολίες στη διαχείριση σε περιβάλλοντα με ασφαλείες τύπους (\e{type-safe}) όπως αυτό της C++, και ίσως κριθεί απαραίτητη η χρήση πιο "ανασφαλών" δομών και δεικτών, ένταντι της υλοποίησης με \mintinline{cpp}{template}.
	\item Είναι σημαντικό να εξεταστούν οι συσχετίσεις μεταξύ των ελέγχων και να βεβαιωθεί πως ένας έλεγχος δεν προκαλεί την γρηγορότερη ή πιο αργή πυροδότηση κάποιου άλλου (π.χ. λόγω επανεκκίνησης αισθητήρα που επαναφέρει στο 0 όλους τους υπόλοιπους ελέγχους).
	\item Το πρότυπο \e{\texttt{ECSS-E-ST-70-41C}} δεν παρέχει ευελιξία στον ορισμό ``έξυπνων'' παραμέτρων, και δεδομένα όπως η \emph{διαφορά μεταξύ τιμών} πρέπει να οριστούν χειροκίνητα στον κώδικα. Επιπλέον, δεν υπάρχει ευελιξία στον ορισμό γε\-γο\-νό\-των-α\-ντι\-δρά\-σε\-ων, καθώς κάθε \acl{event} μπορεί να συνδεθεί με μία μόνο ρυθμιζόμενη αντίδραση.
\end{itemize}
...
Αυτή η διπλωματική εργασία παρουσίασε μόνον μία μελέτη περίπτωσης και μία πειραματική διάταξη για επαλήθευση ενός υποσυνόλου των λειτουργιών του \acs{FDIR}. Ως επόμενο βήμα μπορεί να χαρακτηριστεί η συνέχεια της εφαρμογής αυτής της φιλοσοφίας στην \textbf{κατασκευή του νανοδορυφόρου}, η δοκιμή του \acs{FDIR} στα υποσυστήματα και το τελικό συναρμολογημένο σύστημα, αλλά κυριότερα, η εξαγωγή αποτελεσμάτων από την τροχιά.

Πέρα από τη συνέχιση της εφαρμογής του \acs{FDIR} στον νανοδορυφόρο, μερικοί πιο συγκεκριμένοι στόχοι είναι οι εξής:
\begin{itemize}
	\item Συνέχιση της υλοποίησης των υπηρεσιών \acs{ECSS}. Συγγραφή του κώδικα για επιπλέον δυνατότητες, όπως:
	\begin{compactitem}
		\item Μεταβολή ορισμών παρακολούθησης
		\item Παρακολούθηση πολλών μεταβλητών με συνθήκες \texttt{OR} ή \texttt{AND} ("functional monitoring definitions")
		\item Υποστήριξη αυθαίρετων τύπων δεδομένων για παραμέτρους
		\item Συγγραφή δοκιμών μονάδας (unit tests) για επαλήθευση σε επίπεδο λογισμικού
	\end{compactitem}
	\item Ολοκλήρωση του λογισμικού Ελέγχου Αποστολής (Mission Control) για τον κεντρικό σταθμό βάσης του δορυφόρου, και ενσωμάτωση με τη βάση δεδομένων των υπηρεσιών \acs{ECSS}
	\item Επέκταση του λεπτομερή σχεδιασμού του \acs{FDIR} στην Ασφαλή Λειτουργία
	\item Σύγκριση με άλλες αρχιτεκτονικές ελέγχου του δορυφόρου και αρχιτεκτονικές \acs{FDIR} που χρησιμοποιούνται στη βιομηχανία \parencite{NASA-HDBK-1002,zolghadri_advanced_modelbased_2012}
	\item Επέκταση της θεωρητικής μελέτης (\Cref{sec:theoretical}) και ενοποίηση παραμέτρων όπως κόστος \parencite{chang_development_reliabilitycorrected_2013}, πολυπλοκότητα, προηγούμενη εμπειρία και αρχιτεκτονικές πλεονασμού
	\item Μελέτη μοντέρνων τεχνικών αξιολόγησης αξιοπιστίας και εφαρμογή τους στο νανοδορυφόρο, κατά τον σχεδιασμό ή σε τροχιά
	\item Οργάνωση δοκιμών για εξαγωγή πραγματικών αποτελεσμάτων αξιοπιστίας εξαρτημάτων (π.χ. δοκιμές ακτινοβολίας με βαρέα ιόντα)
\end{itemize}
...
\begin{fullwidth}
	Στο Παράρτημα αυτό παρατίθεται ο πηγαίος κώδικας που αναπαριστά την κύρια λογική της πειραματικής διάταξης. Για τον πλήρη κώδικα που περιλαμβάνει τις βιβλιοθήκες και τα υποστηρικτικά αρχεία, ανατρέξτε στους \Cref{tab:new_software,tab:old_software}. Ο κώδικας αυτού του παραρτήματος γράφτηκε εξ' ολοκλήρου στα πλαίσια της διπλωματικής, και διατηρείται στα αποθετήρια των προαναφερθέντων πινάκων.
\end{fullwidth}
...
\begin{fullwidth}
	Το αρχείο αυτό, γραμμένο στη γλώσσα \href{https://julialang.org/}{Julia}, δημιουργεί όλα τα διαγράμματα της \cref{sec:theoretical}. Μπορεί να βρεθεί επίσης στη διεύθυνση
	\url{https://github.com/kongr45gpen/thesis-latex/tree/main/analysis}.
\end{fullwidth}

\inputminted{julia}{analysis/comparisons_el.jl}

\newpage
\section*{\texttt{main.cpp} {\small(fdir-demo)}}

\begin{fullwidth}
	Πρόκειται για το σημείο έναρξης της εφαρμογής του μικροελεγκτή, όπου ορίζονται οι διεργασίες του λειτουργικού συστήματος, και εκκινείται ο προγραμματιστής.
\end{fullwidth}

\inputminted{cpp}{code/main.cpp}

\newpage
\section*{\texttt{SystemParameters.hpp} {\small(fdir-demo)}}

\begin{fullwidth}
	Εδώ ορίζονται όλες οι παράμετροι που διατηρούνται στον μικροελεγκτή, σε συνδυασμό με τους τύπους δεδομένων τους, και συναρτήσεις που καλούνται κατά την ανάγνωση και την εγγραφή τους.
\end{fullwidth}

\inputminted{cpp}{code/SystemParameters.hpp}

\newpage
\section*{\texttt{SystemParameterMonitoring.hpp} {\small(fdir-demo)}}

\begin{fullwidth}
	Εδώ ορίζονται οι προεπιλεγμένοι ορισμοί παρακολούθησης. Οι τιμές αυτού του αρχείου συμπίπτουν με αυτές του \Cref{tab:demo_monitoring}.
\end{fullwidth}

\inputminted{cpp}{code/SystemParameterMonitoring.hpp}


\newpage
\section*{\texttt{ECSSTask.cpp} {\small(fdir-demo)}}

\begin{fullwidth}
	Εδώ ορίζονται δεδομένα των \acs{ECSS} υπηρεσιών που δεν ορίστηκαν σε άλλα αρχεία. Ακόμα, εδώ εκτελείται ο κύριως βρόχος των υπηρεσιών \acs{ECSS}.
\end{fullwidth}

\inputminted{cpp}{code/ECSSTask.cpp}

\newpage
\section*{\texttt{TemperatureTask.cpp} {\small(fdir-demo)}}

\begin{fullwidth}
	Η διεργασία αυτή είναι η κύρια \acl{interface} του μικροελεγκτή με έναν αισθητήρα θερμοκρασίας. Λαμβάνει την τιμή του κάθε \SI{130}{\milli\second} και ενημερώνει την αντίστοιχη παράμετρο. Ταυτόχρονα, ελέγχει την υγεία του διαύλου \acs{I2C} και προσθέτει εικονικές τιμές αν ζητείται.
\end{fullwidth}

\inputminted{cpp}{code/TemperatureTask.cpp}

\newpage
\section*{\texttt{OnBoardMonitoringService.hpp} {\small(ecss-services)}}

\begin{fullwidth}
	Η καρδιά της λογικής του \acs{FDIR}, αυτή η κλάση δημιουργήθηκε στα πλαίσια αυτής της διπλωματικής, και εκτελεί όλους τους ελέγχους για τον εντοπισμό βλαβών.
\end{fullwidth}

\inputminted{cpp}{code/OnBoardMonitoringService.hpp}

\newpage
\section*{\texttt{xtce.xml} {\small(fdir-demo-yamcs)}}
\label{app:xtce}

\begin{fullwidth}
	Το αρχείο αυτό ορίζει τη μορφή των πακέτων τηλεμετρίας και τηλεεντολών που μπορεί να αντιληφθεί και να εκπέμψει αντίστοιχα ο σταθμός βάσης.
\end{fullwidth}

\inputminted[fontsize=\fontsize{7pt}{7pt}]{xml}{code/xtce-small.xml}

\newpage
\section*{\texttt{ecss-interface.js} {\small(fdir-demo-yamcs)}}

\begin{fullwidth}
	Το αρχείο αυτό είναι το κύριο κομμάτι της εφαρμογής προβολής της βάσης δεδομένων \acs{PUS}. Συνδέεται με το \acs{YAMCS} και προβάλλει τα δεδομένα στον χρήστη. Επίσης έχει τη δυνατότητα αποστολής τηλεεντολών, όταν χρειάζεται ο \acl{microcontroller} να στείλει τα απαραίτητα δεδομένα.
\end{fullwidth}

\inputminted{javascript}{code/ecss-interface.js}

\newpage
\section*{\texttt{link.cpp} {\small(fdir-demo-yamcs)}}

\begin{fullwidth}
	Το αρχείο αυτό λειτουργεί ως το χαμηλότερο επίπεδο στην επικοινωνία υπολογιστή-μικροελεγκτή. Μεταφέρει πακέτα από το \acs{YAMCS} προς το \acs{UART} του μικροελεγκτή και αντίθετα.
\end{fullwidth}
