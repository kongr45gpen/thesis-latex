...
Το πρωτόκολλο \ac{ECSS} \autocite{ECSS-E-ST-70-41C} \g{δεν υποστηρίζεται εγγενώς από το} \acs{YAMCS}. \g{Ωστόσο, οι απαραίτητες εντολές έχουν εισαχθεί στο σύστημα μέσω αρχείων μορφής} \ac{XTCE} \autocite{simon_xtce_standard_2004}. Ο πηγαίος κώδικας της ενσωμάτωσης μπορεί να βρεθεί στο \Cref{app:xtce}.
...
\g{Για να διευκολυνθεί η γρήγορη προβολή της διαδικασίας του} \acs{FDIR}, \g{υλοποιήσαμε μία} online \g{διεπαφή που δείχνει τα παραπάνω} (\Cref{fig:pusviewer}). \g{Η διεπαφή ενημερώνεται σε πραγματικό χρόνο μέσω του} \acs{YAMCS} \acs{HTTP} \acs{API} και προβάλλει τους ορισμούς αλλά και την κατάσταση του \acs{FDIR}.
