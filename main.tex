...
\begin{enumerate}
	\item \emph{Immediately} after the sensor is disconnected, definitions 4, 6, 7, 9, and 10 (\Cref{tab:demo_monitoring}) acquire an \invalid{} state. This happens after deactivation of the \textbf{check validity condition} for these definitions. If sensor 1 is disabled,\footnote[][4ex]{either due to a problem or a command} its values should not be used for any on-board functionality.
...
\begin{table*}[h]
	...
	\begin{tabularx}{\linewidth}{@{}S[table-format=4.0]c@{\hskip 3em}rcl@{\hskip 3em}X@{}}
		...
		\multicolumn{6}{c}{\textcolor{MaterialGrey500}{Failure isolation}}\\[1ex]
		1.5 & 9 & Temp. \( \Delta \) & = & \textminus79.9375 & \ok \ar \invalid \\
		1.5 & 10 & Temp. 1 & = & 109.4375 & \ok \ar \invalid \\
		2 & 4 & Temp. 1 & = & 109.4375 & \hilim \ar \invalid \\
		2 & 6 & Temp. \( \Delta \) & = & \textminus79.9375 & \ok \ar \invalid \\
...
\begin{table*}[h]
	...
	\begin{tabularx}{\linewidth}{@{}S[table-format=4.0]c@{\hskip 3em}rcl@{\hskip 3em}X@{}}
		\toprule
		\multicolumn{1}{l}{Time (s)} & \acs{PMON} & \multicolumn{3}{c@{\hskip 3em}}{Parameter} & Transition \\ \midrule
		0 & 6 & Temp. \( \Delta \) & = & \textminus6.1875 & \ok \ar \lolim \\[1ex]
		\multicolumn{6}{c}{\textcolor{MaterialGrey500}{Failure recovery}}\\[1ex]
		7.5 & 6 & Temp. \( \Delta \) & = & \textminus4.8125 & \lolim \ar \ok \\
		\bottomrule
	\end{tabularx}
	\vspace{10pt}
\end{table*}
...
\begin{table*}[h]
	...
	\begin{tabularx}{\linewidth}{@{}S[table-format=4.0]c@{\hskip 3em}rcl@{\hskip 3em}X@{}}
		...
		2 & 6 & Temp. \( \Delta \) & = & \textminus79.9375 & \ok \ar \lolim \\
		4.5 & 9 & Temp. \( \Delta \) & = & \textminus79.875 & \ok \ar \lolim \\
