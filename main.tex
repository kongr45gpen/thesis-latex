...
\begin{table*}
	...
	\begin{tabularx}{\textwidth}{@{}lL{4cm}L{3.5cm}X@{}}
		...
		\textbf{\texttt{F-050}} & Permanent Value Shift & Ignore sensor 1 & \textbf{Software}: Emulation of large value (permanently)\newline\textbf{Hardware}: Increase temperature difference (permanently) \\
		\textbf{\texttt{F-060}} & \acs{I2C} bus pin output stuck & Ignore sensor 1 & \textbf{Hardware}: Connect \acs{I2C} pin to ground
		\\ \midrule
