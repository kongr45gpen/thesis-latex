...
The \ac{OBSW} subsystem is responsible for the design and development of the nanosatellite's software. The language chosen to be used in the system's 4 \acp{MCU} is a reduced form of \textbf{C++}, and the code is guarded under a number of standards and static checkers.\autocite{DDJF_OBSW} All software runs under the Free\acs{RTOS} operating system.
...
During flight, AcubeSAT can remain within one of the following \textbf{system modes}:\autocite{zaras_acubesat_mission_2021}
\begin{itemize}
